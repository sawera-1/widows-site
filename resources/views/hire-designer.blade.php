...
@section('title', 'Hire Creative Designers — CORAMMERS')
@section('description', 'Scale your creative team instantly. Hire expert UI/UX Designers, Graphic Designers, and Video Editors at 20% of US market cost.')

@push('styles')
    @vite(['resources/css/pages/hire-designer.css'])
@endpush

@push('scripts')
    @vite(['resources/js/pages/hire-designer.js'])
@endpush
            ...
            <div>
                ...
                <div class="hd-hero-label-row">
                    ...
                    <div class="hd-hero-pill">
                        ...
                        <span class="hd-hero-pill-text">Staff Augmentation · Design</span>
                    </div>
                </div>

                <h1 class="hd-hero-heading">
                    Hire Creative Designers<br>
                    That Elevate Your <span class="hd-hero-accent">Brand</span>
                </h1>
                <p class="hd-hero-sub">
                    Our designers craft high-quality visuals and experiences — from UI/UX to
                    graphics and video — helping your brand stand out and convert.
                </p>
