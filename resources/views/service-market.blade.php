...
@section('title', 'Marketing Services — CORAMMERS')
@section('description', 'From data-driven social strategies to precision SEO — we craft scalable, high-performance marketing machines that drive real ROI.')

@push('styles')
    @vite(['resources/css/pages/service-market.css'])
@endpush

@push('scripts')
    @vite(['resources/js/pages/service-market.js'])
@endpush

@section('content')
<div x-data="marketPage()" x-init="init()" :data-theme="theme">
        ...
        <div class="dev-hero-inner">
            ...
            <div class="dev-hero-content" x-bind:style="heroContentStyle">
                ...
                <p class="dev-hero-desc">
                    From data-driven social strategies to precision SEO &mdash; we craft scalable, high-performance marketing machines that drive real ROI.
                </p>
        ...
        <div class="wd-inner">
            <div class="dev-intro-two-col reveal">
                ...
                <div>
                    ...
                    <p class="wd-intro-text">From data-driven social strategies to precision SEO, our team crafts marketing campaigns that resonate with your audience. We combine technical excellence with strategic thinking &mdash; ensuring every campaign serves your goals.</p>
        ...
        <div class="ds-inner">
            <div class="reveal">
                <div style="display:flex;flex-direction:column;align-items:flex-start;">
                    ...
                    <h2 class="wd-section-heading" style="margin:0;">Marketing Services</h2>
                </div>
                <p class="wd-section-sub">We don&rsquo;t just run ads; we build growth engines. From high-impact social campaigns to precision-targeted SEO, our solutions are designed to scale your brand profitably.</p>
            </div>
        ...
        <div class="ds-inner">
            <div class="reveal" style="display:flex;flex-direction:column;align-items:center;">
                <div style="display:flex;flex-direction:column;align-items:center;margin-bottom:24px;">
                    ...
                    <h2 class="wd-section-heading" style="text-align:center;margin-top:24px;margin-bottom:0;">Flexible Marketing Plans</h2>
                </div>
                <p class="wd-section-sub" style="margin:0 auto;text-align:center;">Choose a strategy that fits your growth stage &mdash; no long-term contracts, just results-driven marketing.</p>
            </div>
