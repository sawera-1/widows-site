...
@section('title', 'AI Automation Services — CORAMMERS')
@section('description', 'From intelligent automation agents to generative content systems, our team architects AI products that grow with your business.')

@push('styles')
    @vite(['resources/css/pages/service-ai.css'])
@endpush

@push('scripts')
    @vite(['resources/js/pages/service-ai.js'])
@endpush

@section('content')
<div x-data="aiPage()" x-init="init()" :data-theme="theme">
        ...
        <div class="ds-inner">
            <div class="reveal">
                <div style="display:flex;flex-direction:column;align-items:flex-start;">
                    ...
                    <h2 class="wd-section-heading" style="margin:0;">AI Solutions</h2>
                </div>
