...
@section('title', 'Web Development Services — CORAMMERS')
@section('description', 'We engineer high-performance websites and applications optimized for speed, scalability, and seamless user experience using modern technologies.')

@push('styles')
    @vite(['resources/css/pages/service-development.css'])
@endpush

@push('scripts')
    @vite(['resources/js/pages/service-development.js'])
@endpush

@section('content')
<div x-data="developmentPage()" x-init="init()" :data-theme="theme">
