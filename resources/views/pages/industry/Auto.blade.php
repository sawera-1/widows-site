...
@section('title', 'Automotive Website Design — Corammers')
@section('meta_description', 'Premium automotive websites with online service booking, vehicle estimators, and AI chatbots to increase bookings and sales.')
...
<section class="lf-section lf-section--dark lf-hero">
    ...
    <div class="lf-container">
        ...
        <h1 class="lf-heading lf-hero__heading">
            ...
            <span class="accent">For Automotive Businesses</span>
        </h1>

        <p class="lf-hero__subtext">
            We don’t just build websites; we build Digital Sales Platforms. From instant online service booking to AI-powered customer inquiries, Corammers transforms your auto shop or dealership into a high-performing business.
        </p>
    ...
    <div class="lf-container">
        ...
        <div class="lf-cards-grid">
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Online Service Booking</span>
                <span class="lf-card__tag">&amp; Vehicle Estimator</span>
                <p class="lf-card__desc">Allow customers to instantly book services and estimate costs without picking up the phone.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Instant service booking & scheduling</li>
                    <li><span class="lf-dot"></span> Vehicle issue selection & maintenance requests</li>
                    <li><span class="lf-dot"></span> Service cost estimation & CRM integration</li>
                </ul>
                <div class="lf-card__result">
                    ...
                    <p class="lf-card__desc"><strong>Result:</strong> Generate more qualified service appointments and reduce phone calls.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">AI Service Assistant</span>
                <span class="lf-card__tag">&amp; Customer Automation</span>
                <p class="lf-card__desc">Intelligent automation that works 24/7 to handle appointment scheduling and quote requests while you focus on vehicles.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> 24/7 AI chatbot & Appointment scheduling</li>
                    <li><span class="lf-dot"></span> Service reminders & maintenance follow-ups</li>
                    <li><span class="lf-dot"></span> Quote requests & CRM integration</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Never miss another customer inquiry and improve customer retention.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__tag">Automotive Website</span>
                <p class="lf-card__desc">Built to build trust and show off your expertise with before & after galleries and real customer reviews.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Professional automotive design & Trust-building layout</li>
                    <li><span class="lf-dot"></span> Service-focused landing pages & Before/after galleries</li>
                    <li><span class="lf-dot"></span> Customer reviews & Strong call-to-actions</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Convert more visitors into paying customers.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="lf-section lf-section--dark2">
    <div class="lf-glow"></div>
    <div class="lf-container">
        <h2 class="lf-heading" style="color:var(--white);">What Most Automotive Businesses<br>Are <span class="accent">Missing</span></h2>
        <p class="lf-subtitle" style="color:var(--white);">(Why Their Websites Fail to Convert)</p>

        <div class="lf-missing-grid">
            @php
                $missingItems = [
                    ['title' => 'No Online Appointment Booking', 'desc' => 'Customers leave because they can\'t schedule services easily'],
                    ['title' => 'Slow Customer Response', 'desc' => 'Missing AI chatbots means losing leads after hours'],
                    ['title' => 'Outdated, Slow Website Designs', 'desc' => 'Poor mobile experience and slow load times damage credibility'],
                    ['title' => 'Weak Local SEO & Visibility', 'desc' => 'Your shop doesn\'t appear when locals search for mechanics'],
                    ['title' => 'No CRM Integration', 'desc' => 'Failing to track customer history and maintenance reminders'],
                    ['title' => 'Missing Customer Reviews', 'desc' => 'Without strong reviews, visitors don\'t trust your service'],
                ];
            @endphp
        ...
        <div class="lf-highlight-box">
            ...
            <p class="lf-highlight-box__sub">We solve every one of these challenges with a modern automotive website built to generate leads and increase bookings.</p>
        </div>
...
<section class="lf-section lf-section--light">
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Complete automotive business upgrade, redesigned for maximum impact</p>
        ...
        <div class="lf-deliver-carousel">
            <div class="lf-deliver-track">
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__subtitle">( & Vehicle Service Estimator )</span>
                    <p class="lf-deliver-card__desc">Streamlined booking workflows and service cost calculators.</p>
                    <ul class="lf-deliver-list">
                        <li>Instant service booking integration</li>
                        <li>Vehicle issue selection & estimation</li>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">AI Customer Assistant</span>
                    <span class="lf-deliver-card__subtitle">( CRM Integration )</span>
                    <p class="lf-deliver-card__desc">Automated, round-the-clock lead capture and client engagement.</p>
                    <ul class="lf-deliver-list">
                        <li>24/7 AI-powered service inquiries</li>
                        <li>Seamless auto-shop CRM integration</li>
                        <li>Digital inspection forms & alerts</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Mobile-First Website</span>
                    <span class="lf-deliver-card__subtitle">( Local SEO & Design )</span>
                    <p class="lf-deliver-card__desc">Perfect for shops that demand a high-performance local presence.</p>
                    <ul class="lf-deliver-list">
                        <li>Local SEO optimization & Google Reviews</li>
                        <li>Vehicle galleries & emergency service CTAs</li>
...
<section class="ts-section">
    ...
    <div class="ts-inner">
        ...
        <p class="lf-subtitle" style="margin-bottom: 48px;">Hear from auto dealership and repair shop owners who transformed their online presence</p>
        ...
        <div class="lf-highlight-box" style="margin-top: 64px;">
            ...
            <p class="lf-highlight-box__sub" style="color:var(--white);">Transform your automotive business with a website that actually works for you</p>
        </div>
            ...
            <div class="lf-process__list">
                ...
                <div class="lf-step lf-step--1">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Book a Free 30-Minute Consultation</div>
                            <div class="lf-step__desc">Tell us about your auto shop, services, and website needs.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--3">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Website Development &amp; Integrations</div>
...
<section class="lf-section lf-section--dark" id="book-consultation">
    ...
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Let's discuss how we can transform your automotive website into a high-converting asset.</p>
        ...
        <div class="lf-book-grid">
            ...
            <div class="lf-book-left">
                ...
                <div class="lf-book-card">
                    ...
                    <ul class="lf-book-list">
                        <li>
                            ...
                            Website performance and local SEO audit
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            Service booking workflow strategy
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            AI chatbot & CRM integration demonstration
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                ...
                <div class="lf-book-highlight">
                    ...
                    <p class="lf-book-highlight__sub">We only take on 5 new automotive projects per month to ensure exceptional quality and support.</p>
                </div>
            </div>
...
<section class="lf-section lf-section--light">
    <div class="lf-container" style="max-width: 1600px; width: 95%;">
        ...
        <div class="lf-case-grid custom-case-grid">
            @php
                $caseStudies = [
                    ['tag' => 'Auto Dealership', 'title' => 'Reparo Auto Service', 'desc' => "Increased online bookings and local SEO rankings with a fully integrated service portal.", 'img' => '/assets/industry/auto/auto1.webp', 'link' => 'https://templatekit.kulokale.com/reparo/template-kit/home-1/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Car Repair', 'title' => 'Camma Auto Repair', 'desc' => 'Implemented an AI-powered customer assistant that doubled after-hours service inquiries.', 'img' => '/assets/industry/auto/auto2.webp', 'link' => 'https://kit.bagigambar.net/camma/home/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Auto Service', 'title' => 'Yape Mobility', 'desc' => 'Streamlined the booking process and improved conversion rates with a mobile-first design.', 'img' => '/assets/industry/auto/auto3.webp', 'link' => 'https://yapemobility.it/'],
                    ['tag' => 'Mechanic', 'title' => 'Jettco', 'desc' => 'Boosted visibility and trust through localized SEO and dynamic customer review integration.', 'img' => '/assets/industry/auto/auto4.webp', 'link' => 'https://www.jettco.me/'],
                ];
            @endphp
