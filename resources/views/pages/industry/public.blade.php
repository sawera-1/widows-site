...
@section('title', 'Public Sector Web Development — Corammers')
@section('meta_description', 'Premium public sector websites with citizen service portals, AI assistants, and secure, accessible platforms.')
...
<section class="lf-section lf-section--dark lf-hero">
    ...
    <div class="lf-container">
        ...
        <h1 class="lf-heading lf-hero__heading">
            ...
            <span class="accent">For the Public Sector</span>
        </h1>

        <p class="lf-hero__subtext">
            Build secure, accessible, and citizen-focused digital platforms that improve public services, streamline operations, and strengthen community engagement. We develop government-ready websites that meet accessibility standards, improve transparency, and deliver reliable digital experiences.
        </p>
    ...
    <div class="lf-container">
        ...
        <div class="lf-cards-grid">
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Citizen Service Portal</span>
                <span class="lf-card__tag">&amp; Online Applications</span>
                <p class="lf-card__desc">Simplify public services with digital forms, applications, and self-service portals.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Online application forms</li>
                    <li><span class="lf-dot"></span> Digital document submission</li>
                    <li><span class="lf-dot"></span> Citizen service portal</li>
                    <li><span class="lf-dot"></span> Secure user authentication</li>
                </ul>
                <div class="lf-card__result">
                    ...
                    <p class="lf-card__desc"><strong>Result:</strong> Reduce paperwork while making government services faster and easier to access.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">AI Citizen Assistant</span>
                <span class="lf-card__tag">&amp; Service Automation</span>
                <p class="lf-card__desc">Provide instant answers and automate routine public service requests 24/7.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> AI chatbot for citizen inquiries</li>
                    <li><span class="lf-dot"></span> Department routing</li>
                    <li><span class="lf-dot"></span> Automated request tracking</li>
                    <li><span class="lf-dot"></span> Appointment scheduling</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Improve response times while reducing administrative workload.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Secure Government</span>
                <span class="lf-card__tag">Website Experience</span>
                <p class="lf-card__desc">Deliver a professional, accessible, and high-performance website built for public trust.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Accessibility (WCAG) friendly design</li>
                    <li><span class="lf-dot"></span> Secure infrastructure</li>
                    <li><span class="lf-dot"></span> Mobile-first experience</li>
                    <li><span class="lf-dot"></span> Fast loading performance</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Increase citizen engagement with a secure and reliable digital platform.</p>
                </div>
            </div>
        </div>
    </div>
...
{{-- ===================== SECTION 3 — WHAT MOST PUBLIC SECTOR ORGS ARE MISSING ===================== --}}
<section class="lf-section lf-section--dark2">
    <div class="lf-glow"></div>
    <div class="lf-container">
        <h2 class="lf-heading" style="color:var(--white);">What Most Public Sector Organizations<br>Are <span class="accent">Missing</span></h2>
        <p class="lf-subtitle" style="color:var(--white);">(Why Their Digital Services Fall Behind)</p>

        <div class="lf-missing-grid">
            @php
                $missingItems = [
                    ['title' => 'Outdated Government Websites', 'desc' => 'Slow load times and poor mobile experience damages public trust'],
                    ['title' => 'Poor Mobile Accessibility', 'desc' => 'Citizens struggle to navigate and find crucial information on mobile devices'],
                    ['title' => 'Complicated Online Services', 'desc' => 'Too many hurdles for users to complete simple public requests'],
                    ['title' => 'No Citizen Self-Service Portal', 'desc' => 'Lack of digital platforms forces citizens into long in-person queues'],
                    ['title' => 'Slow Response to Public Inquiries', 'desc' => 'Manual processing leaves citizens waiting for critical answers'],
                    ['title' => 'Weak Security & Accessibility Standards', 'desc' => 'Failing to meet WCAG or data protection requirements'],
                ];
            @endphp
        ...
        <div class="lf-highlight-box">
            <p class="lf-highlight-box__quote">Don't Let These Gaps Hurt Community Trust</p>
            <p class="lf-highlight-box__sub">We build modern public sector websites that improve citizen experiences, increase operational efficiency, and support transparent digital government.</p>
        </div>
...
<section class="lf-section lf-section--light">
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Complete digital transformation solutions for government agencies, municipalities, and public organizations.</p>
        ...
        <div class="lf-deliver-carousel">
            <div class="lf-deliver-track">
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Citizen Portal</span>
                    <span class="lf-deliver-card__subtitle">( Service Platform )</span>
                    <p class="lf-deliver-card__desc">Designed to guide citizens securely and efficiently toward the services they need.</p>
                    <ul class="lf-deliver-list">
                        <li>Online applications</li>
                        <li>Public service dashboards</li>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">AI Citizen Assistant</span>
                    <span class="lf-deliver-card__subtitle">( Smart Support )</span>
                    <p class="lf-deliver-card__desc">A professional, automated support experience that works 24/7.</p>
                    <ul class="lf-deliver-list">
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Government Website</span>
                    <span class="lf-deliver-card__subtitle">( Accessibility & Security )</span>
                    <p class="lf-deliver-card__desc">Perfect for public sector organizations that demand a high-end, accessible, and trustworthy digital presence.</p>
                    <ul class="lf-deliver-list">
...
<section class="ts-section">
    ...
    <div class="ts-inner">
        ...
        <p class="lf-subtitle" style="margin-bottom: 48px;">Hear from government agencies, municipalities, and public organizations that modernized their digital services.</p>
        ...
        <div class="lf-highlight-box" style="margin-top: 64px;">
            ...
            <p class="lf-highlight-box__sub" style="color:var(--white);">Transform your public services with a website that works for both citizens and staff.</p>
        </div>
            ...
            <div class="lf-process__list">
                ...
                <div class="lf-step lf-step--1">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">We discuss your department goals, public services, and digital requirements.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--2">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">Receive a clear roadmap with transparent pricing and flexible project planning.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--3">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Design &amp; Development</div>
                            <div class="lf-step__desc">We build secure, accessible, and scalable government-ready platforms.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--4">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">Continuous maintenance, security updates, and technical support after launch.</div>
                        </div>
                    </div>
                </div>
...
<section class="lf-section lf-section--dark" id="book-consultation">
    ...
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Let's discuss how we can modernize your public services with secure digital solutions.</p>
...
<section class="lf-section lf-section--light">
    <div class="lf-container" style="max-width: 1600px; width: 95%;">
        ...
        <div class="lf-case-grid custom-case-grid">
            @php
                $caseStudies = [
                    ['tag' => 'Public Sector', 'title' => 'Probuild', 'desc' => 'Modernized citizen services with digital applications and self-service tools.', 'img' => '/assets/industry/public/public1.webp', 'link' => 'https://probuildconstructionco.com/'],
                    ['tag' => 'Public Sector', 'title' => 'Koce', 'desc' => 'Improved online service delivery and reduced administrative workload.', 'img' => '/assets/industry/public/public2.webp', 'link' => 'https://kit.nirmanavisual.com/koce/template-kit/home/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Public Sector', 'title' => 'Bagaicha', 'desc' => 'Built an accessible portal for students, parents, and educators.', 'img' => '/assets/industry/public/public3.webp', 'link' => 'https://templatekits.wpmarvels.com/bagaicha/?storefront=envato-elementsTB_iframe%3Dtrue&width=600&height=550'],
                    ['tag' => 'Public Sector', 'title' => 'Tradiz', 'desc' => 'Developed a secure information platform with appointment scheduling and AI assistance.', 'img' => '/assets/industry/public/public4.webp', 'link' => 'https://templatekit.jegtheme.com/tradiz/?storefront=envato-elementsTB_iframe%3Dtrue&width=600&height=550'],
                ];
            @endphp
