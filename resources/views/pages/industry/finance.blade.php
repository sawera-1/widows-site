...
@section('title', 'Financial Advisor Web Development — Corammers')
@section('meta_description', 'Premium websites for financial advisors and wealth management firms. Featuring secure client portals, investment dashboards, and appointment automation.')
...
<section class="lf-section lf-section--dark lf-hero">
    ...
    <div class="lf-container">
        ...
        <h1 class="lf-heading lf-hero__heading">
            ...
            <span class="accent">For Financial Advisors</span>
        </h1>

        <p class="lf-hero__subtext">
            Build credibility and trust with a modern digital presence. We build secure client portals, interactive investment dashboards, and high-converting platforms to help you grow assets under management (AUM).
        </p>
    ...
    <div class="lf-container">
        ...
        <div class="lf-cards-grid">
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Secure Client Portal</span>
                <span class="lf-card__tag">&amp; Financial Dashboard</span>
                <p class="lf-card__desc">Deliver a premium digital experience with secure logins and comprehensive financial tracking.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Secure client login &amp; document sharing</li>
                    <li><span class="lf-dot"></span> Portfolio dashboards &amp; financial reports</li>
                    <li><span class="lf-dot"></span> CRM integration &amp; goal tracking</li>
                </ul>
                <div class="lf-card__result">
                    ...
                    <p class="lf-card__desc"><strong>Result:</strong> A premium digital experience that builds trust and improves client engagement.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">AI Financial Assistant</span>
                <span class="lf-card__tag">&amp; Appointment Automation</span>
                <p class="lf-card__desc">Capture qualified prospects while providing instant support around the clock.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> 24/7 AI chatbot &amp; investment FAQs</li>
                    <li><span class="lf-dot"></span> Appointment scheduling &amp; lead qualification</li>
                    <li><span class="lf-dot"></span> Automated follow-ups &amp; CRM integration</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Capture more qualified prospects while providing instant support.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Trust-Driven Financial</span>
                <span class="lf-card__tag">Website Experience</span>
                <p class="lf-card__desc">Establish credibility from the first click with compliance-focused, professional design.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Professional financial branding &amp; interactive charts</li>
                    <li><span class="lf-dot"></span> Compliance-focused design &amp; trust-building layouts</li>
                    <li><span class="lf-dot"></span> Conversion-optimized landing pages</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Turn website visitors into long-term financial clients.</p>
                </div>
            </div>
        </div>
    </div>
...
{{-- ===================== SECTION 3 — WHAT MOST FINANCIAL ADVISORS ARE MISSING ===================== --}}
<section class="lf-section lf-section--dark2">
    <div class="lf-glow"></div>
    <div class="lf-container">
        <h2 class="lf-heading" style="color:var(--white);">What Most Financial Advisors<br>Are <span class="accent">Missing</span></h2>
        <p class="lf-subtitle" style="color:var(--white);">(Why Their Websites Fail to Convert)</p>

        <div class="lf-missing-grid">
            @php
                $missingItems = [
                    ['title' => 'Outdated Financial Websites', 'desc' => 'Slow load times and clunky designs damage your credibility instantly'],
                    ['title' => 'No Secure Client Portal', 'desc' => 'Failing to provide a private, encrypted space for sensitive documents'],
                    ['title' => 'No Online Appointment Booking', 'desc' => 'Forcing prospects to call during business hours kills conversion rates'],
                    ['title' => 'Weak Credibility & Trust Signals', 'desc' => 'Missing compliance badges, clear branding, and professional layouts'],
                    ['title' => 'No AI Chatbot or Calculators', 'desc' => 'Lacking interactive tools like retirement calculators or 24/7 AI assistants'],
                    ['title' => 'Poor CRM & Lead Generation', 'desc' => 'Slow client communication and manual data entry leaking valuable leads'],
                ];
            @endphp
        ...
        <div class="lf-highlight-box">
            <p class="lf-highlight-box__quote">Don't let these gaps limit your firm's growth.</p>
            <p class="lf-highlight-box__sub">We build modern financial advisor websites designed to establish trust, generate qualified leads, and deliver exceptional client experiences.</p>
        </div>
        ...
        <div class="lf-deliver-carousel">
            <div class="lf-deliver-track">
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Financial Planning Dashboard</span>
                    <span class="lf-deliver-card__subtitle">( Secure Client Portal )</span>
                    <p class="lf-deliver-card__desc">A secure, encrypted environment for clients to view their portfolios.</p>
                    <ul class="lf-deliver-list">
                        <li>Portfolio performance visualization & charts</li>
                        <li>Secure document and report sharing</li>
                        <li>Retirement planning calculators integration</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Online Consultation Booking</span>
                    <span class="lf-deliver-card__subtitle">( Automated Follow-Ups )</span>
                    <p class="lf-deliver-card__desc">A professional scheduling system that links directly to your calendar.</p>
                    <ul class="lf-deliver-list">
                        <li>Calendar sync for seamless booking</li>
                        <li>Automated client follow-ups & reminders</li>
                        <li>CRM integration for new leads</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">AI Financial Assistant</span>
                    ...
                    <ul class="lf-deliver-list">
                        ...
                        <li>Local SEO for Financial Advisors & Google Reviews Integration</li>
...
<section class="ts-section">
    ...
    <div class="ts-inner">
        ...
        <p class="lf-subtitle" style="margin-bottom: 48px;">Hear from financial advisors and wealth managers who transformed their digital presence</p>
        ...
        <div class="lf-highlight-box" style="margin-top: 64px;">
            ...
            <p class="lf-highlight-box__sub" style="color:var(--white);">Transform your advisory firm with a website that actually works for you</p>
        </div>
            ...
            <div class="lf-process__list">
                ...
                <div class="lf-step lf-step--1">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Free Strategy Consultation</div>
                            <div class="lf-step__desc">Tell us about your advisory firm, AUM goals, and website needs.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--2">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">We provide a clear roadmap for your digital transformation.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--3">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Website Development &amp; Client Portal Integration</div>
                            <div class="lf-step__desc">We build your site with compliance, security, and growth in mind.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--4">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">We ensure your website stays fast, secure, and fully updated.</div>
                        </div>
                    </div>
                </div>
...
<section class="lf-section lf-section--dark" id="book-consultation">
    ...
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Let's discuss how we can transform your financial advisor website into a high-converting asset.</p>
            ...
            <div class="lf-book-left">
                ...
                <div class="lf-book-card">
                    ...
                    <ul class="lf-book-list">
                        ...
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            Digital growth &amp; CRM integration strategy
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            Secure client portal &amp; AI assistant planning
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
...
<section class="lf-section lf-section--light">
    <div class="lf-container" style="max-width: 1600px; width: 95%;">
        ...
        <div class="lf-case-grid custom-case-grid">
            @php
                $caseStudies = [
                    ['tag' => 'Wealth Management', 'title' => 'Minerva', 'desc' => 'Build a brand that gets remembered, repeated and rewarded.', 'img' => '/assets/industry/finance/fin1.webp', 'link' => 'https://templatekits.themewarrior.com/minerva/template-kit/home/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Financial Planning', 'title' => 'Optivest', 'desc' => 'Implemented a secure client portal and AI assistant, resulting in higher-quality leads.', 'img' => '/assets/industry/finance/fin2.webp', 'link' => 'https://optivest.tokotema.xyz/template-kit/home/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Retirement', 'title' => 'Aivons', 'desc' => 'Improved client engagement with interactive dashboards and retirement calculators.', 'img' => '/assets/industry/finance/fin3.webp', 'link' => 'https://themesflat.com/aivonskit/template-kit/home-01/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Investment Advisors', 'title' => 'Bisco', 'desc' => 'Strengthened online credibility and delivered a seamless CRM integration for faster onboarding.', 'img' => '/assets/industry/finance/fin4.webp', 'link' => 'https://tykit.widagdos.net/bisco/?storefront=envato-elementsTB_iframe%3Dtrue&width=600&height=550'],
                ];
            @endphp
