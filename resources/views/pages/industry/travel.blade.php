...
@section('title', 'Travel & Hospitality Web Development — Corammers')
@section('meta_description', 'Premium travel and hospitality websites with booking systems, AI assistants, and high-converting digital experiences.')
...
<section class="lf-section lf-section--dark lf-hero">
    ...
    <div class="lf-container">
        ...
        <h1 class="lf-heading lf-hero__heading">
            ...
            <span class="accent">For Travel &amp; Hospitality</span>
        </h1>

        <p class="lf-hero__subtext">
            Create exceptional digital experiences that inspire travelers, increase direct bookings, and elevate your brand. We build modern, high-performance websites for hotels, resorts, travel agencies, tour operators, and hospitality businesses that convert visitors into loyal guests.
        </p>
    ...
    <div class="lf-container">
        ...
        <div class="lf-cards-grid">
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Online Booking</span>
                <span class="lf-card__tag">&amp; Reservation System</span>
                <p class="lf-card__desc">Make booking accommodations, tours, and travel packages fast and effortless.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Online booking engine</li>
                    <li><span class="lf-dot"></span> Room & package availability</li>
                    <li><span class="lf-dot"></span> Secure payment integration</li>
                    <li><span class="lf-dot"></span> Real-time reservation management</li>
                </ul>
                <div class="lf-card__result">
                    ...
                    <p class="lf-card__desc"><strong>Result:</strong> Increase direct bookings while reducing dependency on third-party platforms.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">AI Travel Assistant</span>
                <span class="lf-card__tag">&amp; Guest Support</span>
                <p class="lf-card__desc">Provide instant assistance to travelers before, during, and after their journey.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> AI chatbot for guest inquiries</li>
                    <li><span class="lf-dot"></span> Personalized travel recommendations</li>
                    <li><span class="lf-dot"></span> Booking assistance</li>
                    <li><span class="lf-dot"></span> Automated confirmations & reminders</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Deliver exceptional customer service 24/7 and improve guest satisfaction.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Premium Hospitality</span>
                <span class="lf-card__tag">Website Experience</span>
                <p class="lf-card__desc">Create a visually stunning website that builds trust and encourages bookings.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Luxury, mobile-first design</li>
                    <li><span class="lf-dot"></span> Destination galleries & virtual tours</li>
                    <li><span class="lf-dot"></span> Fast-loading pages</li>
                    <li><span class="lf-dot"></span> SEO optimization</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Increase bookings with a premium digital experience that showcases your brand.</p>
                </div>
            </div>
        </div>
    </div>
...
{{-- ===================== SECTION 3 — WHAT MOST TRAVEL & HOSPITALITY BUSINESSES ARE MISSING ===================== --}}
<section class="lf-section lf-section--dark2">
    <div class="lf-glow"></div>
    <div class="lf-container">
        <h2 class="lf-heading" style="color:var(--white);">What Most Travel &amp; Hospitality Businesses<br>Are <span class="accent">Missing</span></h2>
        <p class="lf-subtitle" style="color:var(--white);">(Why Their Websites Fail to Convert)</p>

        <div class="lf-missing-grid">
            @php
                $missingItems = [
                    ['title' => 'Outdated hotel or travel websites', 'desc' => 'Slow loading speeds and poor mobile experience hurts your brand'],
                    ['title' => 'No online booking system', 'desc' => 'Forcing guests to call or email limits your direct bookings'],
                    ['title' => 'Weak destination galleries', 'desc' => 'Low-quality visuals fail to inspire travelers'],
                    ['title' => 'No AI guest support', 'desc' => 'Limited customer engagement leaves travelers with unanswered questions'],
                    ['title' => 'Poor SEO & local search visibility', 'desc' => 'Travelers can\'t find your business when planning their trip'],
                    ['title' => 'Difficult navigation', 'desc' => 'Low conversion rates due to a confusing user experience'],
                ];
            @endphp
        ...
        <div class="lf-highlight-box">
            <p class="lf-highlight-box__quote">Don't Let These Gaps Cost You Bookings</p>
            <p class="lf-highlight-box__sub">We build modern travel and hospitality websites that attract more guests, increase direct bookings, and provide unforgettable digital experiences.</p>
        </div>
...
<section class="lf-section lf-section--light">
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Complete digital solutions for hotels, resorts, travel agencies, tour operators, and hospitality businesses.</p>
        ...
        <div class="lf-deliver-carousel">
            <div class="lf-deliver-track">
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Hotel &amp; Travel Website Development</span>
                    <span class="lf-deliver-card__subtitle">( Modern Booking Experience )</span>
                    <p class="lf-deliver-card__desc">Complete digital solutions for hotels, resorts, and travel agencies.</p>
                    <ul class="lf-deliver-list">
                        <li>Luxury website design &amp; Destination pages</li>
                        <li>Mobile-first development</li>
                        <li>Online Booking System (Real-time booking, Calendar management, Secure payments)</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">AI Guest Assistant</span>
                    <span class="lf-deliver-card__subtitle">( Smart Customer Support )</span>
                    <p class="lf-deliver-card__desc">Smart chatbot and support automation.</p>
                    <ul class="lf-deliver-list">
                        <li>AI chatbot for 24/7 guest support</li>
                        <li>Personalized travel recommendations</li>
                        <li>Booking assistance &amp; FAQ automation</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Local SEO &amp; Performance</span>
                    <span class="lf-deliver-card__subtitle">( Growth Solutions )</span>
                    <p class="lf-deliver-card__desc">Increase visibility and boost direct bookings.</p>
                    <ul class="lf-deliver-list">
                        <li>Google Business optimization &amp; Technical SEO</li>
                        <li>Guest Experience Features (Photo/video galleries, Virtual tours)</li>
                        <li>Analytics &amp; Business Growth insights</li>
                    </ul>
                </div>
...
<section class="ts-section">
    ...
    <div class="ts-inner">
        ...
        <p class="lf-subtitle" style="margin-bottom: 48px;">Hear from hotel owners, travel agencies, resorts, and hospitality brands that transformed their online presence.</p>
        ...
        <div class="lf-highlight-box" style="margin-top: 64px;">
            ...
            <p class="lf-highlight-box__sub" style="color:var(--white);">Grow your travel business with a website designed to increase bookings and delight every guest.</p>
        </div>
            ...
            <div class="lf-process__list">
                ...
                <div class="lf-step lf-step--1">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">We learn about your hotel, resort, travel agency, or hospitality business.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--2">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">Receive a clear roadmap with transparent pricing and flexible payment options.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--3">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">We build a premium travel website with integrated booking and guest engagement features.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--4">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Launch &amp; Ongoing Support</div>
                            <div class="lf-step__desc">We continuously maintain, optimize, and support your website to maximize bookings.</div>
                        </div>
                    </div>
                </div>
...
<section class="lf-section lf-section--dark" id="book-consultation">
    ...
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Let's discuss how we can transform your travel or hospitality website into a high-converting booking platform.</p>
            ...
            <div class="lf-book-left">
                ...
                <div class="lf-book-card">
                    ...
                    <ul class="lf-book-list">
                        ...
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            SEO &amp; local search recommendations
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            AI guest assistant demonstration
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
...
<section class="lf-section lf-section--light">
    <div class="lf-container" style="max-width: 1600px; width: 95%;">
        ...
        <p class="lf-subtitle">Real travel and hospitality projects delivering measurable business growth.</p>

        <div class="lf-case-grid custom-case-grid">
            @php
                $caseStudies = [
                    ['tag' => 'Luxury Hotel', 'title' => 'The Lotuz', 'desc' => 'Increased direct bookings with a modern booking platform and premium website redesign.', 'img' => '/assets/industry/travel/travel1.webp', 'link' => 'https://elementor.altdesain.com/thelotuz/?storefront=envato-elementsTB_iframe%3Dtrue&width=600&height=550'],
                    ['tag' => 'Travel Agency', 'title' => 'Matour', 'desc' => 'Improved online inquiries and package bookings through a conversion-focused website.', 'img' => '/assets/industry/travel/travel2.webp', 'link' => 'https://templatekit.jegtheme.com/matour/?storefront=envato-elementsTB_iframe%3Dtrue&width=600&height=550'],
                    ['tag' => 'Beach Resort', 'title' => 'Mendouz Suit', 'desc' => 'Enhanced guest engagement with immersive galleries, virtual tours, and online reservations.', 'img' => '/assets/industry/travel/travel3.webp', 'link' => 'https://mendoz-elkit.bolvosites.com/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Tour Operator', 'title' => 'Qomfort', 'desc' => 'Boosted booking conversions with AI-powered customer support and streamlined booking management.', 'img' => '/assets/industry/travel/travel4.webp', 'link' => 'https://themesflat.com/qomfortkit/template-kit/home-01/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                ];
            @endphp
