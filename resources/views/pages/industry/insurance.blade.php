{{-- ============================================================
     insurance.blade.php (ENHANCED)
     Landing page for the Insurance industry page.
     ============================================================ --}}

@extends('layouts.app')

@section('title', 'Insurance Agency Web Development — Corammers')
@section('meta_description', 'Premium insurance agency websites with multi-carrier quote engines, AI assistants, authority-building design and high-converting CTAs.')
...
<section class="lf-section lf-section--dark lf-hero">
    ...
    <div class="lf-container">
        ...
        <h1 class="lf-heading lf-hero__heading">
            ...
            <span class="accent">For Insurance Agencies & Independent Brokers</span>
        </h1>

        <p class="lf-hero__subtext">
            We don’t just build websites; we build Digital Sales Platforms. From instant multi-carrier quote engines to AI-powered client onboarding, Corammers transforms your agency into a top-performing brokerage while you focus on closing.
        </p>
    ...
    <div class="lf-container">
        ...
        <div class="lf-cards-grid">
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Multi-Carrier Engine</span>
                <span class="lf-card__tag">&amp; Instant Quote System</span>
                <p class="lf-card__desc">The biggest barrier in insurance is "Wait for a Callback" friction. We build interactive calculators that provide instant premium estimates, boosting engagement by 12x.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Customer-Friendly Input: Mobile-optimized fields for Auto, Home, or Life data.</li>
                    <li><span class="lf-dot"></span> Real-Time Logic: Estimated pricing based on current project and risk data.</li>
                    <li><span class="lf-dot"></span> Direct CRM Injection: Sends lead data straight to your AMS for instant follow-up.</li>
                </ul>
                <div class="lf-card__result">
                    ...
                    <p class="lf-card__desc"><strong>Result:</strong> Higher-quality leads, instant user value, and a massive competitive advantage.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Smart AI Assistant</span>
                <span class="lf-card__tag">&amp; Underwriting System</span>
                <p class="lf-card__desc">An AI-driven chatbot that does more than just say hello. It works 24/7 to pre-qualify leads and collect data while you focus on closing the most valuable deals.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> 24/7 Intelligent Support: Instant answers to coverage FAQs and inquiries.</li>
                    <li><span class="lf-dot"></span> Data Collection: Captures First Notice of Loss (FNOL) data automatically.</li>
                    <li><span class="lf-dot"></span> Lead Pre-Qualification: Sorts and identifies high-intent clients for your team.</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> Never miss a lead again with intelligent 24/7 automated qualification.</p>
                </div>
            </div>
            ...
            <div class="lf-card">
                ...
                <span class="lf-card__title">Trust-Engineered Design</span>
                <span class="lf-card__tag">and Authority Building</span>
                <p class="lf-card__desc">Insurance is built on trust. Unlike generic templates, our unique design framework uses psychological cues to turn skeptical visitors into clients.</p>
                <span class="lf-card__list-label">What It Includes:</span>
                <ul class="lf-check-list lf-check-list--dots">
                    <li><span class="lf-dot"></span> Authority Cues: Deliberate UI design that builds immediate professional trust</li>
                    <li><span class="lf-dot"></span> Clarity-First Layout: Simplifying complex insurance terms for the average user.</li>
                    <li><span class="lf-dot"></span> Strategic Proofing: Showcasing your expertise through high-conversion layouts.</li>
                </ul>
                <div class="lf-card__result">
                    <span class="lf-result-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.7 10.7l-4 4a.996.996 0 11-1.41-1.41L13.17 13H7c-.55 0-1-.45-1-1s.45-1 1-1h6.17l-1.88-1.88a.996.996 0 111.41-1.41l4 4c.39.39.39 1.03 0 1.41z"/></svg>
                    </span>
                    <p class="lf-card__desc"><strong>Result:</strong> This powerful system works in tandem to de-risk the decision to contact your firm.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="lf-section lf-section--dark2">
    <div class="lf-glow"></div>
    <div class="lf-container">
        <h2 class="lf-heading" style="color:var(--white);">What Most Insurance Agencies<br>Are <span class="accent">Missing</span></h2>
        <p class="lf-subtitle" style="color:var(--white);">(Why Your Current Website Is Losing You Money)</p>

        <div class="lf-missing-grid">
            @php
                $missingItems = [
                    ['title' => 'No AI-Powered Lead Intake', 'desc' => 'Leads slip through the cracks after 5:00 PM and during the weekends.'],
                    ['title' => 'Friction-Heavy Quote Forms', 'desc' => 'Users bail immediately if a form has more than 5 fields on one screen.'],
                    ['title' => 'Missing "Trust Signals"', 'desc' => 'No live carrier logos or broken review widgets make your agency look small.'],
                    ['title' => 'Non-Compliance Liability', 'desc' => 'Ignoring ADA standards (WCAG 2.2) leaves you open to digital lawsuits.'],
                    ['title' => 'Generic Visual Identity', 'desc' => 'Stock photos of handshakes don\'t sell; modern, clean branding does.'],
                    ['title' => 'Manual Data Management', 'desc' => 'Failing to sync lead data instantly with your AMS wastes valuable time.'],
                ];
            @endphp
...
<section class="lf-section lf-section--light">
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Complete Insurance Agency Upgrade</p>
        ...
        <div class="lf-deliver-carousel">
            <div class="lf-deliver-track">
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Instant Quoting</span>
                    <span class="lf-deliver-card__subtitle">(&amp; Multi-Carrier Tool)</span>
                    <p class="lf-deliver-card__desc">Provide immediate premium estimates for Auto, Home, Life, and Business insurance to satisfy the "instant gratification" market.</p>
                    <ul class="lf-deliver-list">
                        <li>Simplified Risk Assessment: User-friendly inputs for rapid data collection.</li>
                        <li>"Send Quote" Triggers: Seamlessly push data to agents for immediate closing.</li>
                        <li>Instant Engagement: Captures user interest when it is at its highest.</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">Smart AI Chatbot</span>
                    <span class="lf-deliver-card__subtitle">(&amp; Automation System)</span>
                    <p class="lf-deliver-card__desc">Ensures you never lose a high-value lead again—even on holidays or weekends—by providing 24/7 automated engagement.</p>
                    <ul class="lf-deliver-list">
                        <li>Automated FAQ Handling: Answering common coverage questions instantly.</li>
                        <li>Multi-Channel Alerts: Real-time lead notifications via SMS or WhatsApp.</li>
                        <li>Smart Booking: Automated scheduling for qualified leads.</li>
                    </ul>
                </div>
                ...
                <div class="lf-deliver-card">
                    ...
                    <span class="lf-deliver-card__title">CTA Strategy</span>
                    <span class="lf-deliver-card__subtitle">(&amp; High-Converting Path)</span>
                    <p class="lf-deliver-card__desc">We place "Get a Quote" and "File a Claim" buttons exactly where users expect them to be, creating a frictionless path to a policy.</p>
                    <ul class="lf-deliver-list">
                        <li>Strategic Placement: Sticky headers and mobile-optimized click-to-call buttons.</li>
                        <li>Benefit-First Copy: Button text engineered to trigger user action.</li>
                        <li>Conversion Engineering: Guiding visitors through a seamless sales funnel.</li>
                    </ul>
                </div>
...
<section class="ts-section">
    ...
    <div class="ts-inner">
        ...
        <p class="lf-subtitle" style="margin-bottom: 48px;">Trust Verified by Thousands of Leads. Star-based ratings from US-based agency owners.</p>
        ...
        <div class="lf-highlight-box" style="margin-top: 64px;">
            ...
            <p class="lf-highlight-box__sub" style="color:var(--white);">Transform your agency with a website that actually works for you</p>
        </div>
...
<section class="lf-section lf-section--light lf-process-section">
    <div class="lf-container">
        ...
        <h2 class="lf-heading">A Smooth, Transparent, and<br>
            <span style="color:var(--primary);">Secure Path to Growth</span>
        </h2>
            ...
            <div class="lf-process__list">
                ...
                <div class="lf-step lf-step--1">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">Tell us about your agency, services, and website needs.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--2">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Final Quote &amp; Timeline (Start with Only 5% Upfront!)</div>
                            <div class="lf-step__desc">We believe in our work—you only pay 5% to get the project started.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--3">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            <div class="lf-step__title">Custom Build &amp; Integration</div>
                            <div class="lf-step__desc">We develop your site and integrate it with your CRM and quoting tools.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lf-step lf-step--4">
                    ...
                    <div class="lf-step__card">
                        ...
                        <div class="lf-step__body">
                            ...
                            <div class="lf-step__desc">We monitor your launch to ensure every lead is captured perfectly.</div>
                        </div>
                    </div>
                </div>
...
<section class="lf-section lf-section--dark" id="book-consultation">
    ...
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Stop settling for a digital brochure. Get a platform that builds your book of business.</p>
            ...
            <div class="lf-book-left">
                ...
                <div class="lf-book-card">
                    ...
                    <ul class="lf-book-list">
                        <li>
                            ...
                            In-depth audit of your current digital presence
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            Custom lead-gen strategy for your agency
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                            Live demo of our "Game-Changer" features
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D81D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                ...
                <div class="lf-book-icons">
                    <div class="lf-icon-card">
                        ...
                        <div class="lf-icon-card__sub">Quick &amp; Focused Strategy</div>
                    </div>
                    <div class="lf-icon-card">
                        ...
                        <div class="lf-icon-card__sub">Via Zoom or Google Meet</div>
                    </div>
                    <div class="lf-icon-card">
                        ...
                        <div class="lf-icon-card__sub">Scheduled to fit your busy hours.</div>
                    </div>
                </div>

                {{-- Block 3: Highlight Card --}}
                <div class="lf-book-highlight">
                    <h4 class="lf-book-highlight__heading">Limited Availability — Secure Your Growth!</h4>
                    <p class="lf-book-highlight__sub">We only take on 5 new insurance agency projects per month to ensure every broker receives exceptional, personalized support.</p>
                </div>
            </div>
...
<section class="lf-section lf-section--light">
    <div class="lf-container" style="max-width: 1600px; width: 95%;">
        ...
        <div class="lf-case-grid custom-case-grid">
            @php
                $caseStudies = [
                    ['tag' => 'Insurance Company', 'title' => 'Decover Insurance Company', 'desc' => 'We’ve weathered storms, rebuilt lives, and protected legacies', 'img' => '/assets/industry/insurance/insurance1.webp', 'link' => 'https://dkkit.rometheme.pro/decover/template-kit/home/?storefront=envato-elementsTB_iframe=true&width=600&height=550'],
                    ['tag' => 'Insurance Solutions', 'title' => 'Minesure', 'desc' => 'At Minesure, our mission is to provide reliable and comprehensive insurance solutions tailored to your needs.', 'img' => '/assets/industry/insurance/insurance2.webp', 'link' => 'https://mhkit.rometheme.pro/minesure/'],
                    ['tag' => 'Insurance Focus', 'title' => 'Azurans', 'desc' => 'Azurans Insurance Company is committed to providing reliable, comprehensive, and customer-focused insurance solutions', 'img' => '/assets/industry/insurance/insurance3.webp', 'link' => 'https://azurans.tokotema.xyz/template-kit/home/'],
                    ['tag' => 'Life Insurance', 'title' => 'LifeForce', 'desc' => 'With a focus on trust, transparency, and personalized service, we offer policies that meet your unique needs.', 'img' => '/assets/industry/insurance/insurance4.webp', 'link' => 'https://templatekit.jegtheme.com/lifeforce/?storefront=envato-elementsTB_iframe%3Dtrue&width=600&height=550'],
                ];
            @endphp
