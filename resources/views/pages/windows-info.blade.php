...
@section('title', 'Windows Information — Energy Efficiency, Security & Quality | Modern UPVC Windows')
@section('meta_description', 'Everything you need to know about our UPVC windows — A+ energy ratings, PAS24:2022 security, Heritage 2800 profiles, Pilkington glass technology, colours, guarantees and in-house precision manufacturing.')
...
{{-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 1 — DESIGNS + ENERGY RATING
     ═══════════════════════════════════════════════════════════════════════════ --}}
        ...
        <div class="wi-grid wi-grid--2">
            ...
            <div class="wi-card">
                <div class="wi-card__img wi-card__img--full">
                    <img src="{{ asset('assets/products/4.2.jpg') }}" alt="Premium UPVC Window Designs" loading="lazy">
                </div>
                ...
                <div class="wi-product-strip">
                    ...
                    @foreach($infoProducts as $wp)
                    @if($wp['type'] === 'windows')
                    <a href="/windows/{{ $wp['slug'] }}" class="wi-product-mini" id="mini-{{ $wp['slug'] }}">
                        <img src="{{ asset('assets/products/' . $wp['img1']) }}" alt="{{ $wp['name'] }}" class="wi-product-mini__img" loading="lazy">
                        {{ $wp['name'] }}
                    </a>
                    @endif
                    @endforeach
            ...
            <div class="wi-card">
                <div class="wi-img-float">
                    <img src="{{ asset('assets/products/4.2.jpg') }}" alt="Energy Efficient Glass" loading="lazy" style="border-radius:0;">
                </div>
            ...
            <div class="wi-card">
                <div class="wi-compare" style="margin-top:0;">
                    <div class="wi-compare-item">
                        <img src="{{ asset('assets/products/4.1.jpg') }}" alt="Standard UPVC Window" class="wi-compare-item__img" loading="lazy">
                        <div class="wi-compare-item__label">Double Glazed A+</div>
                    </div>
                    <div class="wi-compare-item">
                        <img src="{{ asset('assets/products/5.1.jpg') }}" alt="Flush UPVC Window" class="wi-compare-item__img" loading="lazy">
...
{{-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 3 — GLASS + COLOURS + BLINDS + FRAMES
     ═══════════════════════════════════════════════════════════════════════════ --}}
<section class="wi-section">
    <div class="wi-container">
        <div class="wi-section__header">
        ...
        <div class="wi-grid wi-grid--2">
            ...
            <div class="wi-card">
                <div class="wi-card__img wi-card__img--full">
                    <img src="{{ asset('assets/products/5.2.jpg') }}" alt="UPVC Colour Finishes" loading="lazy">
                </div>
            ...
            {{-- S7 — Internal Magnetic Blinds (full width) --}}
            <div class="wi-card wi-col-full">
                <div style="display:grid;grid-template-columns:1fr auto;gap:24px;align-items:start;" class="wi-blind-outer">
                    ...
                    <div style="width:180px;flex-shrink:0;" class="wi-blind-img-col">
                        <img src="{{ asset('assets/products/2.2.jpg') }}" alt="Internal Magnetic Blinds" style="width:100%;display:block;border:1px solid var(--wi-border);" loading="lazy">
                    </div>
                </div>
                <style>
...
{{-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 4 — INDIVIDUAL WINDOW TYPES
     ═══════════════════════════════════════════════════════════════════════════ --}}
        ...
        <div class="wi-grid wi-grid--3">
            ...
            <div class="wi-card">
                <div class="wi-card__img" style="aspect-ratio:4/3;">
                    <img src="{{ asset('assets/products/5.1.jpg') }}" alt="Flush UPVC Windows" loading="lazy">
                </div>
            ...
            <div class="wi-card">
                <div class="wi-card__img" style="aspect-ratio:4/3;">
                    <img src="{{ asset('assets/products/3.1.jpg') }}" alt="French UPVC Windows" loading="lazy">
                </div>
            ...
            <div class="wi-card">
                <div class="wi-card__img" style="aspect-ratio:4/3;">
                    <img src="{{ asset('assets/products/2.1.jpg') }}" alt="Tilt & Turn UPVC Windows" loading="lazy">
                </div>
            ...
            <div class="wi-card">
                <div class="wi-card__img" style="aspect-ratio:4/3;">
                    <img src="{{ asset('assets/products/6.1.jpg') }}" alt="Sash UPVC Windows" loading="lazy">
                </div>
            ...
            {{-- S14 — Standard Casement --}}
            <div class="wi-card">
                <div class="wi-card__img" style="aspect-ratio:4/3;">
                    <img src="{{ asset('assets/products/4.1.jpg') }}" alt="Standard Casement UPVC Windows" loading="lazy">
                </div>
        ...
        <div class="wi-card wi-col-full" style="padding:0;">
            <div style="display:grid; grid-template-columns: 1fr 1fr; align-items: stretch;" class="wi-cta-split">
                <div class="wi-cta-split__img">
                    <img src="{{ asset('assets/about/p3.png') }}" alt="Design your windows" style="width:100%; height:100%; object-fit:cover; display:block;" loading="lazy">
                </div>
