...
<section class="pd-section bg-white dark:bg-black text-black dark:text-white">
    <div class="pd-container payment-grid">
        ...
        {{-- RIGHT: Supporting info + final statement --}}
    ...
    <div class="cta-container">
        <div class="cta-grid">
            ...
            <div class="cta-image-wrapper">
                <img src="{{ asset('assets/about/p1.png') }}" alt="Contact Us Banner" class="cta-image">
            </div>
        </div>
    </div>
</section>
