...
@section('title', 'Choose Your Window Design — uPVC Windows')
@section('meta_description', 'Browse all available uPVC window frame designs. Select a style to design, price and order online.')
                ...
                @foreach($windowFrames as $frame)
                    <a href="{{ $frame['url'] }}"
                       ...
                       aria-label="Select {{ $frame['name'] }} window design">
                        ...
                        {{-- HTML/CSS-built window — NO img, NO SVG asset, NO background-image --}}
