...
@section('title', 'Choose Your Tilt & Turn Window Style — uPVC Windows')
@section('meta_description', 'Browse 5 Tilt & Turn window frame designs. Select a design to price and order online.')
                        ...
                        <div class="wdc-window-wrap">
                            ...
                            <div class="upvc-window {{ $isWide ? 'is-wide' : '' }}"
                                ...
                                @foreach($case['cells'] as $cell)
                                    <div class="upvc-pane {{ !empty($cell['t']) ? 'is-tilt' : '' }} {{ !empty($cell['top_tilt']) ? 'is-top-tilt' : '' }}"
