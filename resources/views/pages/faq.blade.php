...
@section('title', 'Frequently Asked Questions — Modern UPVC Windows')
...
<section class="hero-section">
    <img src="{{ asset('assets/about/faqbanner.png') }}" alt="FAQ Background" class="hero-bg">
            ...
            <div class="faq-category">
                ...
                <div class="faq-list">
                    @foreach($questions as $index => $item)
                        <div class="faq-item {{ $isFirst ? 'is-open' : '' }}">
                            <button class="faq-question" aria-expanded="{{ $isFirst ? 'true' : 'false' }}">
                                <span>{{ $item['question'] }}</span>
                                <span class="faq-icon-wrapper">
                                    {{-- Plus Icon --}}
                                    <svg class="faq-icon plus-icon" style="display: {{ $isFirst ? 'none' : 'block' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                                    {{-- Minus Icon --}}
                                    <svg class="faq-icon minus-icon" style="display: {{ $isFirst ? 'block' : 'none' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"></path></svg>
                                </span>
                            </button>
                            <div class="faq-answer-wrapper" style="{{ $isFirst ? 'max-height: 1000px;' : 'max-height: 0px;' }}">
        ...
        <div class="cta-grid">
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <a href="{{ route('contact') }}" class="btn-solid-white">Contact Us</a>
                    <a href="/" class="btn-outline-white">Design & Price</a>
                </div>
            </div>
            <div class="cta-image-wrapper">
                <img src="{{ asset('assets/about/faq1.png') }}" alt="Contact Us Banner" class="cta-image">
            </div>
        </div>
    </div>
</section>
