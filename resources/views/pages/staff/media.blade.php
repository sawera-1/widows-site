...
@section('title', 'Hire Social Media Experts — Corammers')
@section('meta_description', 'Hire social media specialists from Corammers to grow your brand — strategy, content production and channel management.')

@push('styles')
<link rel="stylesheet" href="{{ asset_v('css/pages/staff-media.css') }}">
@endpush

@section('content')
<div class="pw-staff-media sd-wrapper">
            ...
            <div>
                <div style="display:flex;align-items:flex-start;gap:10px;margin-bottom:14px">
                    ...
                    <div style="display:inline-flex;align-items:center;gap:8px;padding:6px 16px 6px 8px;border-radius:100px;margin-top:6px;border:1.5px solid rgba(216,29,31,0.3);background:rgba(216,29,31,0.08)">
                        ...
                        <span style="font-family:'Montserrat', sans-serif;font-size:0.85rem;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#ffffff">Staff Augmentation · Media &amp; AI</span>
                    </div>
                </div>
                <h1 class="sd-hero-heading">
                    Hire Media Buyers &amp; AI Experts
                    <span class="sd-hero-accent">to Drive Results</span>
                </h1>
                <p class="sd-hero-sub">
                    From high-performing ad campaigns to AI-powered content creation, our experts
                    help you maximize ROI and scale efficiently.
                </p>
                <div class="sd-hero-points">
                    ...
                    <div class="sd-hero-point">
                        <span class="sd-hero-point-icon">
                            <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                                <path d="M2 13l3-4 3 2 3-5 3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </span>
                        Analytics &amp; ROI
                    </div>
                ...
                <div class="sd-hero-ctas">
                    <a href="#" onclick="openCalendlyModal(event)" class="sd-btn-primary">Hire Experts</a>
                </div>
            </div>
            <div class="sd-hero-right">
                <div class="sd-stat-card">
                    <div class="sd-stat-label">Media &amp; AI Experts</div>
                    <div class="sd-stat-value"><em>20</em>+</div>
                    <div class="sd-stat-sub">Buyers, SEO &amp; AI specialists</div>
                </div>
                <div class="sd-stat-card">
                    <div class="sd-stat-label">Ad Spend Managed</div>
                    <div class="sd-stat-value"><em>$2M</em>+</div>
                    <div class="sd-stat-sub">Profitable campaigns</div>
                </div>
                <div class="sd-stat-card">
            ...
            @php
                $staffRoles = [
                    [
                        ...
                        'num' => '01',
                        'points' => ['Paid Ad Campaign Management', 'A/B Creative Testing', 'ROAS & CPA Optimization'],
                    ],
                    [
                        ...
                        'desc' => 'Scale faster with data-driven marketing and AI-powered content strategies designed to deliver measurable results.',
                        'num' => '02',
                        'points' => ['Technical SEO Audits', 'Content & Link Strategy', 'Featured Snippet Optimization'],
                    ],
                    [
                        ...
                        'desc' => 'Scale faster with data-driven marketing and AI-powered content strategies designed to deliver measurable results.',
                        'num' => '03',
                        'points' => ['AI-Generated Blog & Copy', 'Prompt Engineering & Workflows', 'Multi-Platform Content Scaling'],
                    ],
                ];
            @endphp
    ...
    <section class="sd-pricing" id="pricing">
        <div class="sd-pricing-inner">
            ...
            @php
                $pricingData = [
                    ['role' => 'Media Buyer (Meta / Google / TikTok)', 'fullTime' => '$700', 'partTime' => '$380', 'featured' => false],
                    ['role' => 'SEO & AEO Specialist', 'fullTime' => '$600', 'partTime' => '$320', 'featured' => false],
                    ['role' => 'AI Content Creator', 'fullTime' => '$650', 'partTime' => '$350', 'featured' => true],
                ];
            @endphp
    ...
    <section class="sd-team">
        <div class="sd-team-inner">
            ...
            <div class="load-more-wrap js-load-more-wrap">
                <button type="button" class="sd-split-btn" id="mediaLoadMore">
...
<script>
    (function () {
        var root = document.querySelector('.pw-staff-media');
        if (!root) return;
        ...
        var btn = root.querySelector('#mediaLoadMore');
