...
@section('title', 'Choose Your uPVC Door Design & Instant Quote — uPVC Windows')
@section('meta_description', 'Browse all available uPVC and composite door styles. Select a design to customize sizes, colors, glass, and hardware for instant online pricing.')
    ...
    <section class="w-full bg-white dark:bg-black wdc-section" aria-labelledby="wdc-heading">
        <div class="wdc-container">
            ...
            <div class="door-grid" role="list">
                @foreach($doorModels as $door)
                    <a href="/doors/size?design={{ $door['key'] }}"
                       class="wdc-card"
                       role="listitem"
                       aria-label="Select {{ $door['name'] }} door style">

                        <div class="wdc-door-wrap">
                            @include('pages.doors.framedoor', ['design' => $door['key']])
                        </div>
