...
<div class="upvc-door-graphic door-style-{{ $key }}" role="img" aria-label="uPVC Door {{ $key }}">
    <div class="door-sash">
        <div class="door-upper">
            @if($key === 'full-glass' || $key === 'aluminium')
                <div class="door-glass-pane glass-full"></div>
            @elseif($key === 'two-panel' || $key === 'chester' || $key === 'reagan')
                <div class="door-glass-pane glass-half"></div>
            @elseif($key === 'three-panel')
                <div class="door-glass-pane door-glass-v-split">
                    <span class="bar-v"></span>
                </div>
            @elseif($key === 'buckingham')
            ...
            @elseif($key === 'lincoln' || $key === 'roosevelt' || $key === 'truman')
        ...
        <div class="door-lower">
            ...
            @elseif($key === 'chester' || $key === 'harding' || $key === 'lyndon' || $key === 'hayes' || $key === 'woodrow-l' || $key === 'woodrow-d')
                <div class="door-panel-grooved-v"></div>
            @elseif($key === 'filmore')
                <div class="door-panel-grooved-h"></div>
            @elseif($key === 'monroe')
                <div class="door-panel-chevron"></div>
            @elseif($key === 'clinton' || $key === 'grant' || $key === 'reagan' || $key === 'roosevelt' || $key === 'wilson')
            ...
            @elseif($key === 'truman')
                <div class="door-panel-raised-sq"></div>
            @elseif($key === 'full-glass' || $key === 'aluminium' || $key === 'flush-door' || $key === 'washington')
                {{-- Full glass or smooth flush --}}
            @else
