...
@section('title', $article->meta_title ?? $article->title . ' — Advice Centre')
        ...
        <div class="article-layout">
            ...
            <div class="article-main">
                <div class="article-header">
                    <span class="article-cat">{{ $article->category->name ?? 'General' }}</span>
                    <h1 class="article-title">{{ $article->title }}</h1>
                    <div class="article-date">
                        {{ $article->published_at ? $article->published_at->format('jS F Y') : 'Draft' }}
                    </div>
                </div>

                @if($article->featured_image)
                    <img src="{{ asset($article->featured_image) }}" alt="{{ $article->title }}" class="article-featured-img">
                @endif
            ...
            {{-- RIGHT: SIDEBAR — 3 Text Article Cards & Get a Free Quote Box --}}
            <aside class="article-sidebar">
                @if($relatedArticles->count() > 0)
                <div>
                    <h3 class="sidebar-related-title">Related Articles</h3>
                    <div class="sidebar-articles-box">
                        @foreach($relatedArticles->take(3) as $relItem)
                        <a href="{{ route('advice.show', $relItem->slug) }}" class="sidebar-text-card">
                            <h4 class="sidebar-text-card-title">{{ $relItem->title }}</h4>
                ...
                <div class="sidebar-quote-box">
                    ...
                    <a href="{{ route('contact') }}" class="sidebar-quote-btn">Contact Us</a>
                </div>
            </aside>
        </div>
...
<section class="final-cta">
    <div class="final-cta-card">
        <img src="{{ asset('assets/about/window5.png') }}" alt="Get a free quote" class="final-cta-img">
        <div class="final-cta-content">
            ...
            <div class="cta-buttons">
                <a href="{{ route('contact') }}" class="btn-cta-black">Design &amp; Price</a>
                <a href="{{ route('contact') }}" class="btn-cta-outline">Contact Us</a>
            </div>
        </div>
    </div>
</section>
