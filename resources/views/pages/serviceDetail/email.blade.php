...
@section('title', 'Email Marketing Services')
...
@php
    $bgWords = [
        ['text' => 'Campaigns',    'left' => '4%',  'top' => '8%'],
        ['text' => 'Newsletters',  'left' => '38%', 'top' => '4%'],
        ['text' => 'Automation',   'left' => '60%', 'top' => '14%'],
        ['text' => 'Conversions',  'left' => '78%', 'top' => '7%'],
        ['text' => 'Engagement',   'left' => '8%',  'top' => '34%'],
        ['text' => 'A/B Testing',  'left' => '52%', 'top' => '38%'],
        ['text' => 'Retention',    'left' => '74%', 'top' => '28%'],
        ['text' => 'Open Rates',   'left' => '18%', 'top' => '55%'],
        ['text' => 'CRM',          'left' => '44%', 'top' => '60%'],
        ['text' => 'Drip Campaigns','left' => '64%', 'top' => '68%'],
        ['text' => 'Lead Nurturing','left' => '82%', 'top' => '50%'],
        ['text' => 'ROI',          'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['Campaigns', 'Newsletters', 'Automation', 'Conversions', 'Engagement'];
    $row2 = ['A/B Testing', 'Retention', 'Open Rates', 'Lead Nurturing', 'ROI'];
@endphp
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <p class="dev-hero-desc">
                Corammers builds stronger customer relationships and increases conversions through data-driven email marketing campaigns, automated workflows, and personalized lead nurturing.
            </p>
        </div>
        ...
        <div class="dev-hero-right">
            ...
            <p class="dev-hero-right-desc" style="font-style: italic;">
                "Turning Every Email Into a Business Opportunity."
            </p>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'Create targeted email marketing campaigns that increase engagement, strengthen customer relationships, and drive measurable business results.',
            'technologies' => ['Campaign Planning', 'Content Strategy', 'Targeting', 'Promotion', 'Newsletters', 'Retention'],
        ...
        [
            ...
            'desc' => 'Build automated email workflows, drip campaigns, welcome sequences, and lead nurturing funnels that save time and improve conversions.',
            'technologies' => ['Workflows', 'Drip Campaigns', 'Welcome Sequences', 'Lead Nurturing', 'Triggers', 'Sales Funnels'],
        ...
        [
            ...
            'desc' => 'Test subject lines, email content, layouts, and calls-to-action to continuously improve open rates, click-through rates, and overall campaign performance.',
            'technologies' => ['A/B Testing', 'Subject Lines', 'CTAs', 'Layout Optimization', 'Open Rates', 'Click-through Rates'],
        ...
        [
            ...
            'desc' => 'Deliver personalized email experiences by segmenting audiences based on customer behavior, demographics, interests, and purchase history.',
            'technologies' => ['Behavioral Data', 'Demographics', 'Personalization', 'Interests', 'Purchase History', 'Targeting'],
        ...
        [
            ...
            'desc' => 'Connect your email campaigns with CRM platforms to automate communication, improve customer management, and create personalized marketing experiences.',
            'technologies' => ['Salesforce', 'HubSpot', 'Zoho CRM', 'Data Syncing', 'Customer Management', 'API Integration'],
        ...
        [
            ...
            'desc' => 'Monitor campaign performance through detailed reporting on opens, clicks, conversions, engagement, and ROI to make data-driven marketing decisions.',
            'technologies' => ['Performance Reports', 'ROI Tracking', 'Conversion Rates', 'Engagement Metrics', 'Analytics', 'Data-Driven'],
    ...
    <div class="ds-inner">
        <div class="reveal">
            <div style="display:flex;flex-direction:column;align-items:flex-start">
                ...
                <h2 class="wd-section-heading" style="margin:0">Email Marketing <span style="color:var(--accent-theme,#D81D1F)">Services</span></h2>
            </div>
            <p class="wd-section-sub">Create targeted email marketing campaigns, automated workflows, and data-driven strategies that improve engagement and drive measurable business growth.</p>
        </div>
    ...
    <div class="wc-inner">
        <div class="wc-grid">
            ...
            <div class="wc-content">
                ...
                <h2 class="wc-heading">Why Choose Corammers for<br><span class="wc-accent">Email Marketing?</span></h2>
                <p class="wc-para">At Corammers, we combine creative content, automation, and data-driven strategies to deliver email campaigns that generate real business results. Our team focuses on improving customer engagement, increasing conversions, nurturing leads, and maximizing return on investment through personalized email experiences, advanced automation, and continuous campaign optimization.</p>
                <p class="wc-tagline">Corammers – Turning Every Email Into a Business Opportunity.</p>
...
{{-- ══════════════ CLIENT LOGOS ══════════════ --}}
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">Email Campaigns That<br><span class="port-accent">Drive Engagement & Revenue</span></h2>
                        <p class="port-para">Explore how we've helped businesses improve customer retention, increase sales, generate qualified leads, and strengthen brand loyalty through personalized email campaigns, marketing automation, customer segmentation, and performance-focused email strategies.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'What email marketing services do you provide?', 'a' => 'We provide comprehensive email marketing services including campaign strategy, newsletter design, list segmentation, automated workflows, drip campaigns, A/B testing, and detailed performance analytics to ensure maximum ROI.'],
                            ['q' => 'Can you create automated email workflows?', 'a' => 'Yes, we specialize in building complex automated workflows such as welcome sequences, abandoned cart reminders, lead nurturing funnels, and post-purchase follow-ups that save time and increase conversions.'],
                            ['q' => 'Do you design email templates?', 'a' => 'Absolutely. We design custom, responsive, and visually appealing email templates that align with your brand identity and render perfectly across all devices and email clients.'],
                            ['q' => 'Which email marketing platforms do you support?', 'a' => 'We work with industry-leading platforms including Mailchimp, Klaviyo, HubSpot, ActiveCampaign, Constant Contact, and Sendinblue. We can also help you migrate or choose the best platform for your needs.'],
                            ['q' => 'Can you integrate email campaigns with our CRM?', 'a' => 'Yes, we seamlessly integrate your email marketing tools with major CRM systems like Salesforce, HubSpot, and Zoho, ensuring your customer data is always synced and your communications are highly personalized.'],
                            ['q' => 'How do you improve email open rates?', 'a' => 'We improve open rates through rigorous A/B testing of subject lines, optimizing send times based on audience behavior, maintaining clean subscriber lists to ensure deliverability, and segmenting audiences for higher relevance.'],
                            ['q' => 'Will I receive campaign performance reports?', 'a' => 'Yes, transparency is key to our approach. We provide comprehensive monthly reports detailing critical metrics like open rates, click-through rates, bounce rates, conversions, and actionable insights for continuous improvement.'],
                            ['q' => 'How often should marketing emails be sent?', 'a' => 'The ideal frequency depends on your industry, audience, and campaign goals. During our strategy phase, we analyze your data to determine the optimal sending schedule that maximizes engagement without overwhelming your subscribers.'],
                        ];
                    @endphp
    ...
    <div class="lf-container">
        ...
        <p class="lf-subtitle">Let's discuss how we can build stronger customer relationships through strategic email marketing.</p>
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses increase conversions, nurture leads, and maximize ROI through personalized, automated email marketing strategies.
                    </p>
