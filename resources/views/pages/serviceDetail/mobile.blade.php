...
@php
    $bgWords = [
        ['text' => 'iOS',          'left' => '4%',  'top' => '8%'],
        ['text' => 'Android',      'left' => '38%', 'top' => '4%'],
        ['text' => 'React Native', 'left' => '60%', 'top' => '14%'],
        ['text' => 'Flutter',      'left' => '78%', 'top' => '7%'],
        ['text' => 'Swift',        'left' => '8%',  'top' => '34%'],
        ['text' => 'Kotlin',       'left' => '52%', 'top' => '38%'],
        ['text' => 'Firebase',     'left' => '74%', 'top' => '28%'],
        ['text' => 'SQLite',       'left' => '18%', 'top' => '55%'],
        ['text' => 'REST API',     'left' => '44%', 'top' => '60%'],
        ['text' => 'App Store',    'left' => '64%', 'top' => '68%'],
        ['text' => 'Google Play',  'left' => '82%', 'top' => '50%'],
        ['text' => 'Dart',         'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['iOS', 'Android', 'React Native', 'Flutter', 'REST APIs'];
    $row2 = ['Swift', 'Kotlin', 'Firebase', 'App Store', 'Google Play'];
@endphp
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <p class="dev-hero-desc">
                Corammers delivers high-performance mobile app development solutions. From native iOS & Android apps to cross-platform React Native and Flutter experiences, we build secure, scalable, and optimized mobile applications.
            </p>
        </div>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'We design and develop robust native iOS applications using Swift and Objective-C, ensuring seamless performance, premium user experience, and strict adherence to Apple\'s Human Interface Guidelines.',
            'technologies' => ['Swift', 'Objective-C', 'iOS SDK', 'CoreData', 'XCode', 'App Store'],
        ...
        [
            ...
            'desc' => 'Our Android development services leverage Kotlin and Java to build scalable, high-performance apps tailored for the diverse Android ecosystem, delivering flawless functionality across all device types.',
            'technologies' => ['Kotlin', 'Java', 'Android Studio', 'Jetpack', 'Material Design', 'Google Play'],
        ...
        [
            ...
            'desc' => 'Corammers builds powerful cross-platform applications with React Native, allowing you to reach both iOS and Android audiences rapidly without compromising on native-like performance or UI responsiveness.',
            'technologies' => ['React Native', 'JavaScript', 'TypeScript', 'Redux', 'Expo', 'Cross-Platform'],
        ...
        [
            ...
            'desc' => 'Utilize the power of Flutter and Dart to create visually stunning, natively compiled applications for mobile from a single codebase, drastically reducing time to market and development costs.',
            'technologies' => ['Flutter', 'Dart', 'Custom Widgets', 'Firebase', 'State Management', 'Animations'],
        ...
        [
            ...
            'desc' => 'Our design process starts with deep user research to create intuitive wireframes and interactive prototypes, ensuring the final app is highly engaging, accessible, and user-centric.',
            'technologies' => ['UI/UX Design', 'Figma', 'Prototyping', 'Wireframing', 'User Testing', 'Micro-interactions'],
        ...
        [
            ...
            'desc' => 'We handle the entire submission process, ensuring your application meets all stringent guidelines for the Apple App Store and Google Play Store for a smooth and successful launch.',
            'technologies' => ['App Store Connect', 'Google Play Console', 'ASO Optimization', 'Beta Testing', 'CI/CD pipelines', 'Updates'],
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">Turning Ideas Into<br><span class="port-accent">Exceptional</span> Digital Experiences</h2>
                        <p class="port-para">Explore a selection of mobile apps and digital platforms we've crafted for businesses. Every project reflects our commitment to innovative design, scalable development, and measurable business results. We build custom mobile solutions that help brands grow with confidence.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'What technologies do you use to build mobile apps?', 'a' => 'We utilize Native tools like Swift for iOS and Kotlin for Android, as well as robust cross-platform frameworks like React Native and Flutter. We also leverage backend solutions like Node.js, Firebase, and AWS to power scalable mobile infrastructures.'],
                            ['q' => 'How long does a typical mobile app project take?', 'a' => 'Mobile app timelines vary by complexity. An MVP or simple app might take 6–10 weeks, while a full-featured, highly scalable application can take 12–20+ weeks. We provide clear roadmaps during our strategy phase.'],
                            ['q' => 'Do you help with App Store and Google Play deployment?', 'a' => 'Yes, we handle the entire submission and review process for both the Apple App Store and Google Play, ensuring strict compliance with their guidelines and a seamless launch.'],
                            ['q' => 'Can you update or maintain an existing app?', 'a' => 'Absolutely. We offer long-term maintenance packages that include bug fixes, OS update compatibility, performance optimizations, and regular feature expansions to keep your app competitive.'],
                            ['q' => 'How do we get started working together?', 'a' => "Simply fill out the contact form on this page or reach out to us directly. We'll schedule a free 30-minute discovery call to understand your app idea, business goals, and the best path forward."],
                        ];
                    @endphp
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses transform ambitious ideas into high-performing mobile apps that build trust, engage users, and generate qualified leads.
                    </p>
