...
@section('title', 'SEO & AEO Services')
...
@php
    $bgWords = [
        ['text' => 'Rankings',    'left' => '4%',  'top' => '8%'],
        ['text' => 'Keywords',    'left' => '38%', 'top' => '4%'],
        ['text' => 'AEO',         'left' => '60%', 'top' => '14%'],
        ['text' => 'Traffic',     'left' => '78%', 'top' => '7%'],
        ['text' => 'AI Search',   'left' => '8%',  'top' => '34%'],
        ['text' => 'Snippets',    'left' => '52%', 'top' => '38%'],
        ['text' => 'Local SEO',   'left' => '74%', 'top' => '28%'],
        ['text' => 'Authority',   'left' => '18%', 'top' => '55%'],
        ['text' => 'Content',     'left' => '44%', 'top' => '60%'],
        ['text' => 'Backlinks',   'left' => '64%', 'top' => '68%'],
        ['text' => 'Visibility',  'left' => '82%', 'top' => '50%'],
        ['text' => 'Growth',      'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['Rankings', 'Keywords', 'AEO', 'Traffic', 'AI Search'];
    $row2 = ['Snippets', 'Local SEO', 'Authority', 'Backlinks', 'Growth'];
@endphp
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <p class="dev-hero-desc">
                Corammers increases online visibility through advanced SEO and AEO, improving search rankings to drive qualified organic traffic and sustainable growth.
            </p>
        </div>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'Develop customized SEO strategies based on keyword research, competitor analysis, and business objectives to increase long-term organic visibility.',
            'technologies' => ['Keyword Research', 'Competitor Analysis', 'Strategy Strategy', 'Link Building', 'Site Audits', 'Rank Tracking'],
        ...
        [
            ...
            'desc' => 'Optimize your content for AI search, Google AI Overviews, featured snippets, voice search, and answer engines to maximize visibility.',
            'technologies' => ['AI Overviews', 'Featured Snippets', 'Voice Search', 'Knowledge Graph', 'Answer Engines', 'Structured Data'],
        ...
        [
            'title' => 'Technical SEO',
            'desc' => 'Improve website speed, indexing, crawlability, Core Web Vitals, and site architecture to create a strong technical foundation for search performance.',
            'technologies' => ['Core Web Vitals', 'Site Speed', 'Crawlability', 'Indexing', 'Mobile SEO', 'Schema Markup'],
        ...
        [
            ...
            'desc' => 'Create search-focused content structured for both users and AI systems using semantic SEO, FAQs, schema markup, and conversational writing.',
            'technologies' => ['Semantic SEO', 'Conversational Content', 'NLP', 'FAQs', 'Entity SEO', 'Content Clusters'],
        ...
        [
            'title' => 'Local SEO',
            'desc' => 'Increase local search visibility through Google Business Profile optimization, location targeting, citations, and Google Maps optimization.',
            'technologies' => ['Google Maps', 'Local Citations', 'Google Business', 'Reviews Management', 'Local Keywords', 'Geo-targeting'],
        ...
        [
            'title' => 'On-Page SEO',
            'desc' => 'Optimize titles, meta descriptions, headings, internal linking, content structure, and semantic relevance to improve rankings and user experience.',
            'technologies' => ['Meta Tags', 'Internal Linking', 'Content Structure', 'URL Optimization', 'Image SEO', 'Keyword Density'],
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">SEO Strategies That<br><span class="port-accent">Deliver Measurable Growth</span></h2>
                        <p class="port-para">Explore how we've helped businesses improve search visibility, increase organic traffic, optimize website performance, and generate more qualified leads through technical SEO, content optimization, local SEO, and AI-ready search strategies.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'What is SEO?', 'a' => 'SEO (Search Engine Optimization) is the process of optimizing your website to improve its visibility and ranking on search engine results pages (SERPs) like Google. It involves on-page optimization, technical improvements, and building authority to drive organic, unpaid traffic to your site.'],
                            ['q' => 'What is Answer Engine Optimization (AEO)?', 'a' => 'AEO focuses on optimizing content specifically for AI-powered search engines, voice assistants, and featured snippets. It structures information so that AI systems can easily understand and use it to directly answer user queries, ensuring your brand remains visible in modern search formats.'],
                            ['q' => 'How long does SEO take to show results?', 'a' => 'SEO is a long-term strategy. Typically, you can expect to see noticeable improvements in rankings and traffic within 3 to 6 months. However, highly competitive industries may take longer, as search engines need time to crawl, index, and evaluate the authority of your optimized content.'],
                            ['q' => 'Do you optimize for Google AI Overviews?', 'a' => 'Yes, our AEO strategies are designed to help your content appear in Google AI Overviews and featured snippets. We use semantic SEO, structured data markup, and conversational Q&A formats to make your content easily digestible for AI systems.'],
                            ['q' => 'Can you improve local search rankings?', 'a' => 'Absolutely. We offer dedicated Local SEO services, including optimizing your Google Business Profile, managing local citations, encouraging customer reviews, and implementing geo-targeted keywords to help you dominate local search results.'],
                            ['q' => 'Do you provide technical SEO audits?', 'a' => 'Yes, every comprehensive SEO strategy begins with an in-depth technical audit. We identify and fix issues related to site speed, mobile responsiveness, crawlability, indexing, and architecture to ensure a solid foundation for search success.'],
                            ['q' => 'Will you optimize my existing website?', 'a' => 'Yes, we can perform on-page, off-page, and technical SEO on your existing website, regardless of the platform it was built on. We work with your current infrastructure to improve performance without requiring a full rebuild.'],
                            ['q' => 'Do you provide monthly SEO reports?', 'a' => 'Yes, transparency is a core part of our service. We provide detailed monthly reports that track your keyword rankings, organic traffic growth, conversions, and technical improvements, so you always know the exact ROI of your campaign.'],
                        ];
                    @endphp
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses increase their online visibility, capture high-intent search traffic, and achieve long-term growth through advanced SEO & AEO strategies.
                    </p>
