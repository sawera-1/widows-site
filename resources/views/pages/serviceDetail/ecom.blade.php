...
@section('title', 'E-Commerce Development Services')
...
@php
    $bgWords = [
        ['text' => 'Shopify',      'left' => '4%',  'top' => '8%'],
        ['text' => 'WooCommerce',  'left' => '38%', 'top' => '4%'],
        ['text' => 'Magento',      'left' => '60%', 'top' => '14%'],
        ['text' => 'BigCommerce',  'left' => '78%', 'top' => '7%'],
        ['text' => 'Headless',     'left' => '8%',  'top' => '34%'],
        ['text' => 'Stripe',       'left' => '52%', 'top' => '38%'],
        ['text' => 'Next.js',      'left' => '74%', 'top' => '28%'],
        ['text' => 'Tailwind',     'left' => '18%', 'top' => '55%'],
        ['text' => 'REST API',     'left' => '44%', 'top' => '60%'],
        ['text' => 'GraphQL',      'left' => '64%', 'top' => '68%'],
        ['text' => 'PayPal',       'left' => '82%', 'top' => '50%'],
        ['text' => 'Inventory',    'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['Shopify', 'WooCommerce', 'Magento', 'BigCommerce', 'Headless Commerce'];
    $row2 = ['Stripe', 'PayPal', 'Next.js', 'GraphQL', 'Inventory'];
@endphp
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <h1 class="dev-hero-heading">
                Building<br>
                <span class="accent">Scalable</span><br>
                <span class="accent">Online</span>
                Stores
            </h1>

            <p class="dev-hero-desc">
                Corammers delivers high-performance e-commerce development solutions. We build secure, scalable, and high-converting online stores using Shopify, WooCommerce, Magento, BigCommerce, and custom headless architectures to maximize your sales.
            </p>
        </div>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'Build powerful Shopify stores with custom themes, app integrations, optimized checkout experiences, and scalable solutions designed to maximize conversions and business growth.',
            'technologies' => ['Shopify Plus', 'Liquid', 'Custom Apps', 'Store Setup', 'Checkout Optimization', 'Migrations'],
        ...
        [
            ...
            'desc' => 'Create flexible and feature-rich WooCommerce stores with secure payment gateways, inventory management, and custom functionality tailored to your business.',
            'technologies' => ['WordPress', 'WooCommerce', 'Payment Gateways', 'Inventory', 'Plugin Integration', 'SEO Optimization'],
        ...
        [
            ...
            'desc' => 'Develop enterprise-grade Magento stores that deliver exceptional performance, advanced product management, and seamless shopping experiences for growing businesses.',
            'technologies' => ['Magento 2', 'B2B/B2C', 'Adobe Commerce', 'ERP Integration', 'Performance', 'Scalability'],
        ...
        [
            ...
            'desc' => 'Design scalable BigCommerce solutions with high-speed performance, secure checkout systems, and integrations that support long-term e-commerce success.',
            'technologies' => ['BigCommerce', 'B2B Commerce', 'Headless', 'Custom API', 'Store Design', 'Theme Customization'],
        ...
        [
            ...
            'desc' => 'Build lightning-fast shopping experiences using modern headless architecture, giving businesses complete flexibility across web, mobile, and multiple sales channels.',
            'technologies' => ['Next.js', 'React', 'GraphQL', 'Contentful', 'Vercel', 'Omnichannel API'],
        ...
        [
            'title' => 'Payment & Marketplace Integration',
            'desc' => 'Integrate secure payment gateways, shipping providers, CRMs, ERPs, Amazon, eBay, and other third-party platforms to automate your entire online business.',
            'technologies' => ['Stripe / PayPal', 'Shipping APIs', 'CRM / ERP', 'Amazon Integration', 'eBay / Walmart', 'Automations'],
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">Building Online Stores <br><span class="port-accent">That Drive</span> Sales</h2>
                        <p class="port-para">Showcase successful e-commerce websites, online marketplaces, and digital shopping experiences developed for businesses worldwide. Highlight responsive design, secure checkout systems, modern UI, and scalable architectures that help brands increase revenue and customer engagement.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'How long does it take to build an online store?', 'a' => 'Depending on the complexity, an MVP store on Shopify or WooCommerce can take 2–6 weeks. Custom Headless Commerce or enterprise Magento solutions typically take 8–16+ weeks. We outline exact timelines during our discovery phase.'],
                            ['q' => 'Which platform is best: Shopify or WooCommerce?', 'a' => 'It depends on your business. Shopify is excellent for ease-of-use, hosted security, and rapid scaling. WooCommerce offers complete ownership and extensive customization since it\'s built on WordPress. We will help you choose the right fit.'],
                            ['q' => 'Can you migrate my existing store?', 'a' => 'Yes, we handle seamless data migrations (products, customers, order history) from legacy platforms like Magento 1, old WooCommerce setups, or custom builds to modern systems without losing SEO rankings.'],
                            ['q' => 'Do you integrate payment gateways?', 'a' => 'Absolutely. We integrate all major payment gateways including Stripe, PayPal, Authorize.Net, Apple Pay, and Google Pay to ensure a secure and smooth checkout process.'],
                            ['q' => 'Can you build custom checkout systems?', 'a' => 'Yes, for headless architectures and advanced platforms, we build customized, high-converting checkout flows that reduce cart abandonment and provide a frictionless buying experience.'],
                            ['q' => 'Will my store be mobile responsive?', 'a' => '100%. Over 70% of e-commerce traffic comes from mobile devices. We take a mobile-first approach, ensuring fast loading times, intuitive navigation, and flawless experiences on all screens.'],
                            ['q' => 'Can you integrate shipping providers?', 'a' => 'Yes, we integrate with FedEx, UPS, USPS, DHL, and local couriers via direct APIs or third-party solutions to automate real-time shipping rates and fulfillment tracking.'],
                            ['q' => 'Do you provide ongoing maintenance?', 'a' => 'We offer dedicated support retainers to handle security updates, plugin upgrades, performance monitoring, and continuous conversion rate optimization (CRO).'],
                            ['q' => 'Will my store be SEO optimized?', 'a' => 'Yes, we build e-commerce sites with SEO best practices in mind, including clean URLs, semantic markup, fast load speeds, and structured schema data to help your products rank higher.'],
                            ['q' => 'Can you scale my store as my business grows?', 'a' => 'Our development approach ensures your architecture is highly scalable. We use cloud infrastructure, headless setups, and performance optimizations so your store handles traffic spikes and high transaction volumes effortlessly.'],
                        ];
                    @endphp
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses transform outdated websites into high-performing e-commerce platforms that build trust and drive sales.
                    </p>
