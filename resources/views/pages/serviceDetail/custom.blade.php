...
@php
    $bgWords = [
        ['text' => 'MongoDB',    'left' => '4%',  'top' => '8%'],
        ['text' => 'Express.js', 'left' => '38%', 'top' => '4%'],
        ['text' => 'React.js',   'left' => '60%', 'top' => '14%'],
        ['text' => 'Node.js',    'left' => '78%', 'top' => '7%'],
        ['text' => 'JavaScript', 'left' => '8%',  'top' => '34%'],
        ['text' => 'TypeScript', 'left' => '52%', 'top' => '38%'],
        ['text' => 'Next.js',    'left' => '74%', 'top' => '28%'],
        ['text' => 'Tailwind',   'left' => '18%', 'top' => '55%'],
        ['text' => 'REST API',   'left' => '44%', 'top' => '60%'],
        ['text' => 'Firebase',   'left' => '64%', 'top' => '68%'],
        ['text' => 'Redux',      'left' => '82%', 'top' => '50%'],
        ['text' => 'GitHub',     'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'REST APIs'];
    $row2 = ['JWT Auth', 'Tailwind CSS', 'Next.js', 'Firebase', 'GitHub'];
@endphp
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <h1 class="dev-hero-heading">
                ...
                <span class="accent">That Powers</span><br>
                <span class="accent">Modern</span>
                Businesses
            </h1>

            <p class="dev-hero-desc">
                Corammers develops fully customized web applications designed around each client's unique business requirements. Using modern technologies like React.js, Next.js, Node.js, Laravel, PHP, MongoDB, and MySQL, we build scalable architectures with secure API integrations. Our focus is on delivering exceptional performance optimization, responsive interfaces, and long-term maintainability. Every solution is engineered from scratch to automate workflows, improve operational efficiency, and support your business growth. Corammers — Transforming Business Ideas into Powerful Custom Software Solutions.
            </p>
        </div>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'Modern interactive front-end applications with reusable components, responsive interfaces, and exceptional performance.',
            'technologies' => ['React.js', 'Redux', 'Hooks', 'Context API', 'SPA', 'Performance'],
        ...
        [
            ...
            'desc' => 'SEO-friendly server-side rendered and static web applications optimized for speed, scalability, and user experience.',
            'technologies' => ['Next.js', 'SSR/SSG', 'API Routes', 'Vercel', 'SEO', 'Tailwind CSS'],
        ...
        [
            ...
            'desc' => 'Build secure REST APIs, real-time applications, authentication systems, and scalable backend architectures.',
            'technologies' => ['Node.js', 'Express.js', 'WebSockets', 'Microservices', 'Auth', 'REST API'],
        ...
        [
            ...
            'desc' => 'Develop enterprise-grade portals, dashboards, CRM systems, ERP solutions, and custom business software with clean architecture.',
            'technologies' => ['Laravel', 'PHP 8+', 'Livewire', 'Blade', 'MVC', 'Security'],
        ...
        [
            ...
            'desc' => 'Design efficient MySQL and MongoDB databases while integrating payment gateways, CRMs, ERPs, third-party APIs, and cloud services.',
            'technologies' => ['MySQL', 'MongoDB', 'PostgreSQL', 'Stripe', 'Cloud Storage', 'Third-Party APIs'],
        ...
        [
            ...
            'desc' => 'Develop complete business platforms including SaaS products, management systems, booking platforms, marketplaces, and internal business software.',
            'technologies' => ['SaaS', 'ERP / CRM', 'Booking Systems', 'Marketplaces', 'Dashboards', 'Scale'],
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">Custom Software Built <br><span class="port-accent">for Real Business</span> Challenges</h2>
                        <p class="port-para">Corammers has successfully delivered custom CRM systems, ERP platforms, SaaS applications, booking platforms, and internal management systems. Our expertise extends to business dashboards, digital marketplaces, fintech platforms, healthcare solutions, logistics software, and enterprise web applications, all engineered using the latest modern technologies for maximum impact.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'What is custom software development?', 'a' => 'Custom software development is the process of designing, creating, deploying, and maintaining software tailored specifically for a set of users, functions, or organizations, rather than using off-the-shelf commercial software.'],
                            ['q' => 'Why choose a custom web application over ready-made software?', 'a' => 'Custom software is built to fit your exact workflows seamlessly, meaning you aren\'t forced into the rigid constraints of a pre-built platform. It scales with you, provides superior security, and integrates perfectly with your existing internal tools.'],
                            ['q' => 'Which technologies do you use?', 'a' => 'We utilize a modern tech stack focused on scalability and performance, including React.js, Next.js, Node.js, Express.js, Laravel, PHP, MongoDB, and MySQL, alongside robust cloud deployments.'],
                            ['q' => 'Do you develop React and Next.js applications?', 'a' => 'Yes, we heavily leverage React.js for building highly interactive user interfaces and Next.js for scalable, SEO-friendly applications that demand lightning-fast performance.'],
                            ['q' => 'Can you build Laravel and PHP systems?', 'a' => 'Absolutely. We develop enterprise-grade backends, portals, CRMs, and ERP solutions using clean architecture and modern PHP frameworks like Laravel.'],
                            ['q' => 'Do you develop REST APIs?', 'a' => 'Yes, designing secure, performant REST APIs is central to our development process. We ensure that your frontends and third-party systems can communicate reliably and securely.'],
                            ['q' => 'Can you modernize an existing application?', 'a' => 'Yes. We frequently audit and refactor legacy codebases, migrating them to modern technologies like React or Laravel, optimizing database queries, and improving system architecture without losing existing data.'],
                            ['q' => 'Do you provide maintenance after launch?', 'a' => 'Yes, we offer comprehensive long-term technical support, performance monitoring, security patching, and future feature enhancements to ensure your platform remains cutting-edge.'],
                            ['q' => 'Can you integrate third-party services?', 'a' => 'We can integrate almost any third-party service via APIs, including payment gateways (Stripe, PayPal), CRMs (Salesforce, HubSpot), ERP systems, AI models, cloud storage, and automated marketing tools.'],
                            ['q' => 'How long does a custom software project take?', 'a' => 'Timelines vary greatly based on project scope. A targeted internal tool may take 4-8 weeks, while a complex SaaS platform or ERP system can span 3-6 months. We provide detailed roadmaps during our initial discovery phase.'],
                        ];
                    @endphp
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses transform workflows with high-performing software that builds trust and drives growth.
                    </p>
