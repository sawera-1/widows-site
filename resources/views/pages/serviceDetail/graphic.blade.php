...
@section('title', 'Graphic Design Services')
...
@php
    $bgWords = [
        ['text' => 'Photoshop',    'left' => '4%',  'top' => '8%'],
        ['text' => 'Illustrator', 'left' => '38%', 'top' => '4%'],
        ['text' => 'InDesign',   'left' => '60%', 'top' => '14%'],
        ['text' => 'Figma',    'left' => '78%', 'top' => '7%'],
        ['text' => 'Canva', 'left' => '8%',  'top' => '34%'],
        ['text' => 'CorelDRAW', 'left' => '52%', 'top' => '38%'],
        ['text' => 'After Effects',    'left' => '74%', 'top' => '28%'],
        ['text' => 'Premiere',   'left' => '18%', 'top' => '55%'],
        ['text' => 'Branding',   'left' => '44%', 'top' => '60%'],
        ['text' => 'Typography',   'left' => '64%', 'top' => '68%'],
        ['text' => 'Print Design',      'left' => '82%', 'top' => '50%'],
        ['text' => 'Digital Art',     'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['Photoshop', 'Illustrator', 'InDesign', 'Figma', 'CorelDRAW'];
    $row2 = ['Branding', 'Typography', 'Print Design', 'Digital Art', 'Logo Design'];
@endphp
...
<section class="dev-hero pw-home" id="devHero">
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <h1 class="dev-hero-heading" style="font-size: clamp(2rem, 4vw, 3.5rem); line-height: 1.2;">
                Creative Graphic Design Services That<br>
                <span class="accent">Build Powerful Brands</span>
            </h1>

            <p class="dev-hero-desc">
                Corammers delivers creative graphic design solutions that establish a memorable, professional brand identity. From logos to marketing materials, our visually compelling graphics strengthen your brand across all digital and print platforms.
            </p>
        </div>
        ...
        <div class="dev-hero-right">
            ...
            <p class="dev-hero-right-desc" style="font-style: italic;">
                "Corammers – Transforming Ideas into Powerful Visual Experiences."
            </p>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'Build a memorable and professional brand identity with custom logos, typography, color systems, and complete branding guidelines designed to establish trust and recognition.',
            'technologies' => ['Logos', 'Typography', 'Brand Guidelines', 'Identity'],
        ...
        [
            'title' => 'Print Design',
            'desc' => 'Design high-quality brochures, business cards, flyers, packaging, catalogs, banners, and promotional materials that communicate your brand effectively in print.',
            'technologies' => ['Brochures', 'Packaging', 'Business Cards', 'Banners'],
        ...
        [
            ...
            'desc' => 'Create engaging website graphics, social media posts, advertisements, email banners, presentation designs, and marketing assets that drive engagement online.',
            'technologies' => ['Social Media', 'Web Graphics', 'Ads', 'Banners'],
        ...
        [
            ...
            'desc' => 'Develop unique illustrations, icons, infographics, and visual storytelling assets that make your brand more engaging and easier to understand.',
            'technologies' => ['Illustrations', 'Icons', 'Infographics', 'Storytelling'],
        ...
        [
            ...
            'desc' => 'Design impactful promotional graphics for campaigns, events, product launches, exhibitions, and digital marketing that capture attention and increase conversions.',
            'technologies' => ['Campaigns', 'Events', 'Product Launches', 'Marketing'],
        ...
        [
            ...
            'desc' => 'Create professional eBooks, magazines, reports, catalogs, company profiles, and publications with visually appealing layouts that improve readability and brand presentation.',
            'technologies' => ['eBooks', 'Magazines', 'Reports', 'Catalogs'],
    ...
    <div class="ds-inner">
        <div class="reveal">
            <div style="display:flex;flex-direction:column;align-items:flex-start">
                ...
                <h2 class="wd-section-heading" style="margin:0">Graphic Design Services</h2>
            </div>
            <p class="wd-section-sub">Design high-quality brochures, business cards, flyers, packaging, catalogs, banners, and promotional materials that communicate your brand effectively.</p>
        </div>
    ...
    <div class="wc-inner">
        <div class="wc-grid">
            ...
            <div class="wc-content">
                ...
                <h2 class="wc-heading">Why Businesses Choose <span class="wc-accent">Corammers</span><br>For Graphic Design</h2>
                <p class="wc-para">We combine creativity with strategic thinking to design visuals that strengthen your brand and improve communication. Every design is crafted with consistency and a deep understanding of your business goals to help you stand out.</p>
                <p class="wc-tagline">Corammers — Building Digital Experiences That Businesses Trust.</p>
                <a href="/contact" class="wc-cta-btn">Let's Design Your Brand</a>
            </div>
...
{{-- ══════════════ CLIENT LOGOS ══════════════ --}}
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">Creative Designs That<br><span class="port-accent">Bring Brands to Life</span></h2>
                        <p class="port-para">Explore our portfolio of branding projects, digital graphics, marketing campaigns, packaging designs, and creative assets developed for businesses across multiple industries. Every project reflects our commitment to quality, creativity, and measurable business impact.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'Why is professional graphic design important?', 'a' => 'Professional graphic design ensures your brand is visually appealing, consistent, and memorable, helping you stand out from competitors and build trust with your audience.'],
                            ['q' => 'Do you create complete brand identities?', 'a' => 'Yes, we design comprehensive brand identities including logos, typography, color palettes, and brand guidelines to ensure consistency across all your marketing channels.'],
                            ['q' => 'Can you redesign our existing logo?', 'a' => 'Absolutely. We can modernize and refine your existing logo while retaining your brand\'s core essence, giving it a fresh and professional look.'],
                            ['q' => 'Do you provide social media graphics?', 'a' => 'Yes, we create custom social media graphics tailored to each platform, including posts, stories, banners, and ad creatives to boost online engagement.'],
                            ['q' => 'Are print-ready files included?', 'a' => 'Yes, for all print projects, we provide high-resolution, print-ready files with proper bleed, crop marks, and color profiles (CMYK) to ensure flawless printing.'],
                            ['q' => 'Do you design marketing materials?', 'a' => 'We design a wide range of marketing materials including brochures, flyers, business cards, posters, and digital ad graphics that effectively communicate your message.'],
                            ['q' => 'How many revisions are included?', 'a' => 'We typically include a set number of revisions (usually 2-3 rounds) to ensure the final design meets your expectations, with options for additional revisions if needed.'],
                            ['q' => 'What file formats will I receive?', 'a' => 'You will receive all necessary file formats depending on the project, such as vector files (AI, EPS, SVG) for scalability, and raster files (PNG, JPG, PDF) for web and print use.'],
                        ];
                    @endphp
    ...
    <div class="lf-container">
        <h2 class="lf-heading">Ready to Elevate Your Brand with <span class="accent">Stunning Graphic Design?</span></h2>
        <p class="lf-subtitle">Whether you're launching a new business, refreshing your brand identity, or creating marketing materials, Corammers delivers creative graphic design solutions that help your business stand out and leave a lasting impression.</p>
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses transform outdated graphics into high-performing brand assets that build trust and generate qualified leads.
                    </p>
