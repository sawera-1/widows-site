...
@section('title', 'Social Media Marketing Services')
...
@php
    $bgWords = [
        ['text' => 'Instagram',    'left' => '4%',  'top' => '8%'],
        ['text' => 'TikTok',       'left' => '38%', 'top' => '4%'],
        ['text' => 'Facebook',     'left' => '60%', 'top' => '14%'],
        ['text' => 'LinkedIn',     'left' => '78%', 'top' => '7%'],
        ['text' => 'Analytics',    'left' => '8%',  'top' => '34%'],
        ['text' => 'Engagement',   'left' => '52%', 'top' => '38%'],
        ['text' => 'Leads',        'left' => '74%', 'top' => '28%'],
        ['text' => 'Strategy',     'left' => '18%', 'top' => '55%'],
        ['text' => 'Content',      'left' => '44%', 'top' => '60%'],
        ['text' => 'ROI',          'left' => '64%', 'top' => '68%'],
        ['text' => 'Growth',       'left' => '82%', 'top' => '50%'],
        ['text' => 'Ads',          'left' => '28%', 'top' => '78%'],
    ];
    $row1 = ['Instagram', 'TikTok', 'Facebook', 'LinkedIn', 'Analytics'];
    $row2 = ['Engagement', 'Lead Generation', 'Content Strategy', 'Paid Ads', 'Growth'];
@endphp
    ...
    <div class="dev-hero-grid">
        ...
        <div class="dev-hero-left">
            ...
            <h1 class="dev-hero-heading" style="font-size: clamp(2rem, 4.5vw, 3.5rem); line-height: 1.1;">
                Social Media<br>
                <span class="accent">Marketing</span><br>
                Services
            </h1>

            <p class="dev-hero-desc">
                Corammers helps businesses grow their online presence by creating engaging content and managing strategic campaigns across leading social platforms.
            </p>
        </div>
...
@php
    ...
    $webServices = [
        [
            ...
            'desc' => 'Plan and create engaging content that aligns with your brand and connects with your target audience.',
            'technologies' => ['Content Planning', 'Copywriting', 'Visual Assets', 'Brand Voice', 'Content Calendars', 'Storytelling'],
        ...
        [
            ...
            'desc' => 'Launch targeted advertising campaigns on Facebook, Instagram, LinkedIn, and TikTok to generate leads.',
            'technologies' => ['Facebook Ads', 'Instagram Ads', 'LinkedIn Ads', 'TikTok Ads', 'Retargeting', 'A/B Testing'],
        ...
        [
            ...
            'desc' => 'Full-service management of your social profiles, including posting, scheduling, and community engagement.',
            'technologies' => ['Scheduling', 'Platform Management', 'Hashtag Strategy', 'Profile Optimization', 'Posting', 'Trend Analysis'],
        ...
        [
            ...
            'desc' => 'Build meaningful relationships with your audience through active moderation, replies, and interaction.',
            'technologies' => ['Moderation', 'Audience Building', 'Customer Support', 'Brand Loyalty', 'Direct Messages', 'Comments'],
        ...
        [
            ...
            'desc' => 'Design social media funnels that turn followers into qualified leads and paying customers.',
            'technologies' => ['Social Funnels', 'Lead Magnets', 'Conversion Tracking', 'Lead Forms', 'Audience Targeting', 'CTAs'],
        ...
        [
            ...
            'desc' => 'Track performance, measure ROI, and optimize your social media strategy based on data insights.',
            'technologies' => ['Performance Tracking', 'ROI Measurement', 'Audience Insights', 'Engagement Metrics', 'Custom Reports', 'Data Strategy'],
            ...
            <div class="port-grid">
                ...
                <div class="port-content">
                    <div class="port-content-card">
                        <h2 class="port-heading">Social Media Campaigns<br>That <span class="port-accent">Deliver Results</span></h2>
                        <p class="port-para">Discover how we've helped businesses increase brand awareness, grow engaged communities, generate quality leads, and improve conversions through creative content, strategic advertising, and performance-driven social media campaigns.</p>
        ...
        <section class="faq-section-bg">
            <div class="faq-inner">
                ...
                <div class="faq-list">
                    @php
                        $faqs = [
                            ['q' => 'Which social media platforms do you manage?', 'a' => 'We manage campaigns across all major platforms including Facebook, Instagram, LinkedIn, TikTok, and Twitter (X). We tailor our approach to focus on the platforms where your target audience is most active.'],
                            ['q' => 'Do you create the content for our social media?', 'a' => 'Yes, our team handles the entire content creation process. This includes graphic design, video editing, copywriting, and developing a cohesive visual strategy that aligns with your brand identity.'],
                            ['q' => 'How do you measure the success of a campaign?', 'a' => 'We measure success using key performance indicators (KPIs) such as engagement rate, reach, website clicks, and lead generation. We provide regular reports so you can clearly see the ROI of your social media marketing.'],
                            ['q' => 'Can you help us with paid social media advertising?', 'a' => 'Absolutely. We design, launch, and optimize paid ad campaigns on platforms like Facebook, Instagram, and LinkedIn to target specific demographics, generate leads, and drive conversions effectively.'],
                            ['q' => 'How do we get started with your social media services?', 'a' => "Simply fill out the contact form or book a free consultation through our website. We'll discuss your business goals, evaluate your current social presence, and build a custom strategy to help you grow."],
                        ];
                    @endphp
            ...
            <div class="lf-book-left">
                <div class="lf-why-card">
                    ...
                    <p class="lf-left-desc">
                        We help businesses build strong online communities, generate qualified leads, and drive sustainable growth through strategic social media marketing.
                    </p>
