...
@section('title', 'Hire Media Buyers & AI Experts — CORAMMERS')
@section('description', 'Scale your marketing and content team instantly. Hire expert Paid Media Buyers, SEO/AEO Specialists, and AI Content Creators at 20% of US market cost.')

@push('styles')
    @vite(['resources/css/pages/hire-media.css'])
@endpush

@push('scripts')
    @vite(['resources/js/pages/hire-media.js'])
@endpush
            ...
            <div>
                ...
                <div class="hd-hero-label-row">
                    ...
                    <div class="hd-hero-pill">
                        ...
                        <span class="hd-hero-pill-text">Staff Augmentation · Media &amp; AI</span>
                    </div>
                </div>

                <h1 class="hd-hero-heading">
                    Hire Media Buyers &amp;<br>
                    AI Experts to Drive <span class="hd-hero-accent">Results</span>
                </h1>
                <p class="hd-hero-sub">
                    From high-performing ad campaigns to AI-powered content creation, our
                    experts help you maximize ROI and scale efficiently.
                </p>
