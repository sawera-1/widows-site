<?php $__env->startSection('title', 'Choose Your Flush Door Style — uPVC Windows'); ?>
<?php $__env->startSection('meta_description', 'Browse 21 Flush double door designs. Customize dimensions, glazing, side panels, and frame colors for instant online quotes.'); ?>
...
<main id="content">
    <section class="w-full bg-white dark:bg-black wdc-section">
        <div class="wdc-container">
            ...
            <?php $__currentLoopData = $flushDoorCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catTitle => $models): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-12">
                    <h2 class="flush-cat-title"><?php echo e($catTitle); ?></h2>
                        ...
                        <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $door): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="/doors/size?design=<?php echo e($door['key']); ?>" class="wdc-card">
                                <div class="wdc-door-wrap">
                                    <?php echo $__env->make('pages.doors.flushdoor-graphic', ['design' => $door['key']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/doors/flushdoor.blade.php ENDPATH**/ ?>