<?php $__env->startSection('title', 'Installation — Modern UPVC Windows'); ?>
...
<section class="inst-section bg-white dark:bg-black text-black dark:text-white">
    <div class="inst-container intro-grid">
        ...
        <div class="intro-img-wrapper">
            <img src="<?php echo e(asset('assets/about/d1.png')); ?>" alt="Window Installation">
        </div>
    </div>
</section>
...
<section class="inst-section bg-white dark:bg-black text-black dark:text-white">
    <div class="inst-container areas-grid">
        ...
        <div class="areas-image">
            <img src="<?php echo e(asset('assets/about/d2.png')); ?>" alt="Installation Areas" style="width: 100%; object-fit: cover;">
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/installationpage.blade.php ENDPATH**/ ?>