<?php $__env->startSection('title', 'Order Confirmation — Company Name'); ?>
...
<section class="success-section bg-white dark:bg-black text-black dark:text-white min-h-screen">
    <div class="success-container">
        ...
        <p class="success-subtitle">Thank you for your order, <?php echo e($order->first_name); ?>. We've received it and are processing it now.</p>
        
        <div class="order-details-card">
            <div class="odc-grid">
                <div>
                    <div class="odc-label">Order Number</div>
                    <div class="odc-value"><?php echo e($order->order_number); ?></div>
                </div>
                <div>
                    <div class="odc-label">Date</div>
                    <div class="odc-value"><?php echo e($order->created_at->format('M j, Y')); ?></div>
                </div>
                <div>
                    <div class="odc-label">Payment Status</div>
                    <div class="odc-value" style="color: #10b981;"><?php echo e(ucfirst($order->payment_status)); ?></div>
                </div>
                <div>
                    <div class="odc-label">Total Amount</div>
                    <div class="odc-value">&pound;<?php echo e(number_format($order->total, 2)); ?></div>
                </div>
                <div>
                    <div class="odc-label">Delivery Method</div>
                    <div class="odc-value"><?php echo e(ucfirst($order->delivery_method)); ?></div>
                </div>
                <div>
                    <div class="odc-label">Billing Email</div>
                    <div class="odc-value"><?php echo e($order->email); ?></div>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    ...
                                    <span style="font-size: 0.85rem; color: var(--mono-grey);"><?php echo e($item->width); ?>mm &times; <?php echo e($item->height); ?>mm</span>
                                </td>
                                <td style="text-align: center;"><?php echo e($item->quantity); ?></td>
                                <td style="text-align: right; font-weight: 500;">&pound;<?php echo e(number_format($item->line_total, 2)); ?></td>
                            </tr>
            ...
            <div style="display: flex; justify-content: space-between; border-top: 2px solid var(--mono-border-light); padding-top: 16px; font-weight: 700; font-size: 1.1rem;" class="dark:border-zinc-800">
                ...
                <span>&pound;<?php echo e(number_format($order->total, 2)); ?></span>
            </div>
        </div>
        
        <div class="action-buttons">
            <a href="<?php echo e(route('track-order')); ?>" class="btn-black">Track Order</a>
            <a href="<?php echo e(url('/')); ?>" class="btn-secondary">Continue Shopping</a>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/checkout-success.blade.php ENDPATH**/ ?>