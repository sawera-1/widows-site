...
<div style="margin-bottom: 20px;">
    <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-outline">Back to Products</a>
</div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="form-group">
                ...
                <?php if($product->image): ?>
                    <div style="margin-bottom: 10px;">
                        <img src="<?php echo e(asset('assets/products/' . $product->image)); ?>" style="max-height: 100px; border-radius: 0; border: 1px solid #e5e7eb;">
                    </div>
                <?php else: ?>
            ...
            <div class="form-group">
                ...
                <?php if($product->hover_image): ?>
                    <div style="margin-bottom: 10px;">
                        <img src="<?php echo e(asset('assets/products/' . $product->hover_image)); ?>" style="max-height: 100px; border-radius: 0; border: 1px solid #e5e7eb;">
                    </div>
                <?php else: ?>
