...
<?php if (! $__env->hasRenderedOnce('stable-door-component-styles')): $__env->markAsRenderedOnce('stable-door-component-styles'); ?>
<style>
...
<div class="stable-door-graphic door-style-<?php echo e($key); ?>" role="img" aria-label="Stable Door <?php echo e($key); ?>">
    
    <div class="stable-sash-top">
        <?php if($key === 'kelham'): ?>
            <div class="sd-glass-pane sd-glass-kelham"></div>
        <?php elseif($key === 'kelham-grill'): ?>
...
<?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/doors/stabledoor-graphic.blade.php ENDPATH**/ ?>