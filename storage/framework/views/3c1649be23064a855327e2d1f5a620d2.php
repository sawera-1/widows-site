<?php $__env->startSection('title', 'Contact Us — Modern UPVC Windows'); ?>
    ...
    <div class="contact-container">
        <div class="contact-grid">
            ...
            <div>
                ...
                <form action="<?php echo e(route('contact.submit')); ?>" method="POST" enctype="multipart/form-data" class="contact-form">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="john@example.com" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" class="form-control" placeholder="How can we help you today?" required><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/contactus.blade.php ENDPATH**/ ?>