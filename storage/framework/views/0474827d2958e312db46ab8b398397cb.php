                    ...
                    <div class="chk-form-section">
                        ...
                        <div class="chk-grid two-cols" style="margin-top: 16px;">
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" id="billing_county" name="billing_county" class="chk-input" value="<?php echo e(old('billing_county')); ?>">
                            </div>
                        </div>
                        <div class="chk-grid two-cols" style="margin-top: 16px;">
                            <div class="field-group">
                    ...
                    <div class="chk-form-section" id="deliveryAddressSection">
                        ...
                        <div class="chk-grid">
                            <div class="field-group">
                                ...
                                <input type="text" id="delivery_address" name="delivery_address" class="chk-input" value="<?php echo e(old('delivery_address')); ?>">
                            </div>
                        </div>
                    </div>
