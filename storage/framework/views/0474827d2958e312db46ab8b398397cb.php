<?php $__env->startSection('title', 'Checkout — Company Name'); ?>
                    ...
                    <div class="chk-form-section">
                        ...
                        <div class="chk-grid two-cols">
                            <div class="field-group">
                                ...
                                <input type="text" id="first_name" name="first_name" class="chk-input" required value="<?php echo e(old('first_name')); ?>">
                            </div>
                            <div class="field-group">
                                <label for="last_name">Last Name *</label>
                                <input type="text" id="last_name" name="last_name" class="chk-input" required value="<?php echo e(old('last_name')); ?>">
                            </div>
                        </div>
                        <div class="chk-grid two-cols" style="margin-top: 16px;">
                            <div class="field-group">
                                <label for="email">Email Address *</label>
                                <input type="email" id="email" name="email" class="chk-input" required value="<?php echo e(old('email')); ?>">
                            </div>
                            <div class="field-group">
                                <label for="phone">Phone Number</label>
                                <input type="tel" id="phone" name="phone" class="chk-input" value="<?php echo e(old('phone')); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="chk-form-section">
                        ...
                        <div class="chk-grid">
                            <div class="field-group">
                                ...
                                <input type="text" id="billing_address" name="billing_address" class="chk-input" required value="<?php echo e(old('billing_address')); ?>">
                            </div>
                        </div>
                        <div class="chk-grid" style="margin-top: 16px;">
                            <div class="field-group">
                                <label for="billing_city">Town / City *</label>
                                <input type="text" id="billing_city" name="billing_city" class="chk-input" required value="<?php echo e(old('billing_city')); ?>">
                            </div>
                        </div>
                        <div class="chk-grid two-cols" style="margin-top: 16px;">
                            <div class="field-group">
                                <label for="billing_postcode">Postcode *</label>
                                <input type="text" id="billing_postcode" name="billing_postcode" class="chk-input" required value="<?php echo e(old('billing_postcode')); ?>">
                            </div>
                            <div class="field-group">
                    ...
                    <div class="chk-form-section" id="deliveryAddressSection">
                        ...
                        <div class="chk-grid">
                            <div class="field-group">
                                ...
                                <input type="text" id="delivery_address" name="delivery_address" class="chk-input" required value="<?php echo e(old('delivery_address')); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="chk-radio-group">
                            <label class="chk-radio-label">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 0.85rem; color: var(--mono-grey);">Pay in cash when your order is delivered.</div>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="chk-summary">
                        ...
                        <div class="cs-items">
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="cs-item">
                                    <div>
                                        <div class="cs-item-name"><?php echo e(ucwords(str_replace('-', ' ', $item['design_slug']))); ?> &times; <?php echo e($item['quantity']); ?></div>
                                        <div class="cs-item-meta"><?php echo e($item['width']); ?>mm &times; <?php echo e($item['height']); ?>mm</div>
                                    </div>
                                    <div style="font-weight: 500;">
                                        &pound;<?php echo e(number_format($item['line_total'], 2)); ?>
                        ...
                        <div class="cs-total">
                            <span>Total</span>
                            <span id="txtTotalCost" data-subtax="<?php echo e($subtotal + $tax); ?>">&pound;<?php echo e(number_format($total + 50, 2)); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/checkout.blade.php ENDPATH**/ ?>