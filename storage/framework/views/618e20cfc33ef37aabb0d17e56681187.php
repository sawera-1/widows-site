<?php $__env->startSection('title', 'Doors Information — Security, Energy Efficiency & Quality | Modern UPVC Windows'); ?>
<?php $__env->startSection('meta_description', 'Everything you need to know about our UPVC doors — PAS24 security, 5-point locking, Ultion cylinder upgrade, energy efficiency, Heritage profiles, colours, guarantees and in-house precision manufacturing.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/doors-info.blade.php ENDPATH**/ ?>