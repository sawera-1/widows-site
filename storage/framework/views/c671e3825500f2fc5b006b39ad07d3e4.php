<?php $__env->startSection('title', 'Modern UPVC Windows & Doors — Design, Price & Order Online'); ?>
<?php $__env->startSection('meta_description', 'Premium uPVC windows and doors. Design your perfect window or door online, get an instant price, and order with secure checkout and fast delivery.'); ?>
        ...
        <div class="gc">
            ...
            <div class="benefits-grid">
                ...
                <div class="benefit-card">
                    <img src="<?php echo e(asset('assets/icon/search.png')); ?>" alt="" class="w-10 h-10 mb-4 object-contain dark:invert" />
                ...
                <div class="benefit-card">
                    <img src="<?php echo e(asset('assets/icon/planning.png')); ?>" alt="" class="w-10 h-10 mb-4 object-contain dark:invert" />
                ...
                <div class="benefit-card">
                    <img src="<?php echo e(asset('assets/icon/paper.png')); ?>" alt="" class="w-10 h-10 mb-4 object-contain dark:invert" />
                ...
                <div class="benefit-card">
                    <img src="<?php echo e(asset('assets/icon/express-delivery.png')); ?>" alt="" class="w-10 h-10 mb-4 object-contain dark:invert" />
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/home.blade.php ENDPATH**/ ?>