...
<?php if (! $__env->hasRenderedOnce('flush-door-component-styles')): $__env->markAsRenderedOnce('flush-door-component-styles'); ?>
<style>
...
<div class="flush-door-graphic door-style-<?php echo e($key); ?>" role="img" aria-label="Flush Door <?php echo e($key); ?>">
    <?php if($hasTopLight): ?>
        <div class="transom-top-light">
            <?php if($hasLeftPanel): ?> <div class="transom-pane"></div> <?php endif; ?>
            <div class="transom-pane" style="flex:2;"></div>
            <?php if($hasRightPanel): ?> <div class="transom-pane"></div> <?php endif; ?>
        </div>
    <?php endif; ?>
...
<?php /**PATH D:\internship\windows site\windows-laravel\resources\views/pages/doors/flushdoor-graphic.blade.php ENDPATH**/ ?>